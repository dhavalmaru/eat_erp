...
class Login extends CI_Controller
{
    ...
    public function check_credentials() {
        ...
        if(count($result) > 0 ) {
			...
			set_cookie('email',$uname,'3600*1000'); 
			set_cookie('password',$upass,'3600*1000');
			set_cookie('firstname',$firstname,'3600*1000');
			set_cookie('lastname',$lastname,'3600*1000');
