...
function save_data($id='') {
    ...
    if($this->input->post('btn_approve')!=null || $this->input->post('btn_reject')!=null){
        ...
        if($status == 'Rejected'){
            ...
            $action='Batch Processing Entry '.$status.'.';
        } else {
            if($id!='' || $ref_id!=''){
...
function save_tentative_data($id='') {
    $now=date('Y-m-d H:i:s');
    $curusr=$this->session->userdata('session_id');
    ...
    if($this->input->post('btn_approve')!=null || $this->input->post('btn_reject')!=null){
        ...
        if($status == 'Rejected'){
            ...
            $action='Tentative Stock Entry '.$status.'.';
        } else {
            if($id!='' || $ref_id!=''){
                if($ref_id!=null && $ref_id!=''){
                    $sql = "Update batch_processing A, batch_processing B 
        ...
        if($id==''){
            ...
            if($this->input->post('status')=="Approved"){
                $action='Tentative Stock Entry Modified.';
            } else {
                $action='Tentative Stock Entry Created.';
            }
