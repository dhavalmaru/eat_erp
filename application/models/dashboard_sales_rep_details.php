			...
			<div class="row">
				<div class="col s12">
					<div class="entry" style="text-align:center;">
						...
						<div class="name green accent-2" style="text-align:center;margin:15px auto;"><?php if(isset($get_cookie['first_name'])) {echo substr($get_cookie['first_name'], 0, 1);} if(isset($get_cookie['last_name'])) {echo substr($get_cookie['last_name'], 0, 1);} ?></div>
					
						<h5><?php if(isset($get_cookie['first_name'])) {echo $get_cookie['first_name'];} if(isset($get_cookie['last_name'])) {echo $get_cookie['last_name'];} ?></h5>
					</div>
				</div>
