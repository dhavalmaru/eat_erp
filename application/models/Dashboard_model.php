...
class Dashboard_model extends CI_Model {
    ...
    function get_notifications($notification_type='') {
        ...
        $sql = "select A.*, B.p_status from notifications A left join production_details B on(A.reference_id = B.id) 
                where A.status='Approved' and (A.user_type='All' or A.user_id='$curusr') and 
                A.notification_type = '$notification_type' and date(A.notification_date)<=date(notification_date)";
