...
class Production_model Extends CI_Model{
    ...
    function confirm($id=''){
        ...
        if(count($result)>0){
            ...
            $this->notification_model->add_notification('3', $notification, $now, $notification_type, 'All', '', $id);
        }
    ...
    function confirm_batch($id=''){
        ...
        if(count($result)>0){
            ...
            $this->notification_model->add_notification('4', $notification, $now, $notification_type, 'All', '', $id);
        }
    ...
    function confirm_raw_material($id=''){
        ...
        $sql = "select * from notification_master where id in ('5', '6', '7', '8', '9', '10')";
        $query=$this->db->query($sql);
        $result=$query->result();
        if(count($result)>0){
