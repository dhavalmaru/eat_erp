...
public function get_sales_rep_email(){
	   ...
	   /* $to_email = "rishit.sanghvi@eatanytime.in,sulochana@eatanytime.co.in,mukesh@eatanytime.in, mis@eatanytime.co.in";*/
		$bcc = "sangeeta.yadav@pecanreams.com, dhaval.maru@pecanreams.com";
		/*$bcc = "ashwini.patil@pecanreams.com, sangeeta.yadav@pecanreams.com, dhaval.maru@pecanreams.com, swapnil.darekar@eatanytime.in";*/
           ...
           <table  class="body_table" style="border-collapse: collapse;width:100%">
			<thead>
				<tr style=" background-color: #f3f3f3 ;border-bottom: 1px solid #ddd;font-weight: bold;">
				  ...
				  <th style="border-right: 1px solid #ddd;padding: 8px;text-align: left;">Name Of Employee</th>
				  <th style="border-right: 1px solid #ddd;padding: 8px;text-align: left;">Beat Name</th>
          ...
          '; 
				...
				if(count($data)>=0) {
					for($i=0; $i<count($data); $i++)
					{
						...
						{							
								$deviation=(($data[$i]->actual_count)/($data[$i]->planned_count))*100;
							
						
								$tbody.= ' <tr>
									
									<td style="border-right: 1px solid #ddd;padding: 8px;text-align: left;color:#222">'.$data[$i]->sales_rep_name.'<p style="color: #881818; text-transform: UPPERCASE;font-size: 14px;margin-top: 5px;
    margin-bottom: 5px;">
									'.$data[$i]->emp_status.'
									</p></td>
