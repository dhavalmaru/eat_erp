        ...
        if(count($result)>0){
            ...
            for($i=0; $i<count($result); $i++){
                ...
                if($date_of_visit!=''){
                    ...
                    $col = $col + 1;
                    $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=+'.$col_name[$col-1].$row.'-$'.$col_name[$col].'$17');
                    $col = $col + 1;
                ...
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=SUM('.$col_name[$col+1].$row.':'.$col_name[$col+8].$row.')');
                $col = $col + 1;
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=+'.$col_name[$col-10].$row.'-'.$col_name[$col-22].$row);
                $col = $col + 1;
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=+'.$col_name[$col-10].$row.'-'.$col_name[$col-22].$row);
                $col = $col + 1;
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=+'.$col_name[$col-10].$row.'-'.$col_name[$col-22].$row);
                ...
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=SUM('.$col_name[$col+1].$row.':'.$col_name[$col+8].$row.')');
                $col = $col + 1;
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=IF('.$col_name[$col-22].$row.'<$F$'.$row.'/2,$F$'.$row.',0)');
                $col = $col + 1;
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=IF('.$col_name[$col-22].$row.'<$F$'.$row.'/2,$F$'.$row.',0)');
                $col = $col + 1;
                $objPHPExcel->getActiveSheet()->setCellValue($col_name[$col].$row, '=IF('.$col_name[$col-22].$row.'<$F$'.$row.'/2,$F$'.$row.',0)');
            ...
            $objPHPExcel->getActiveSheet()->getStyle('A19:'.$col_name[$col].$row)->applyFromArray(array(
                'borders' => array(
                    'allborders' => array(
                        'style' => PHPExcel_Style_Border::BORDER_THIN
                    )
            ...
            $col = $col + 2;
            $objPHPExcel->getActiveSheet()->getStyle($col_name[$col].'19:'.$col_name[$col+9].$row)->applyFromArray(array(
                'borders' => array(
                    'allborders' => array(
                        'style' => PHPExcel_Style_Border::BORDER_THIN
                    )
            ...
            $col = $col + 11;
            $objPHPExcel->getActiveSheet()->getStyle($col_name[$col].'19:'.$col_name[$col+8].$row)->applyFromArray(array(
                'borders' => array(
                    'allborders' => array(
                        'style' => PHPExcel_Style_Border::BORDER_THIN
                    )
