...
function generate_agingwise_report() {
    ...
    $sql = "select I.*, J.distributor_type, J.sales_rep_name,J.area,J.location,J.zone,J.so1,J.so2 from 
            ...
            (select distributor_id, ifnull(round(sum(days_0_30),2),0) as days_0_30, 

                ifnull(round(sum(days_30_45),2),0) as days_30_45, 

                ifnull(round(sum(days_46_60),2),0) as days_46_60, 

                ifnull(round(sum(days_61_90),2),0) as days_61_90, 
            ...
            (select distributor_id, round(sum(payment_amount),2) as paid_amount from payment_details_items 
            ...
            select distributor_id, round(sum(final_amount),2) as paid_amount from distributor_in 
