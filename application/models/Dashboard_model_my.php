...
class Dashboard_model extends CI_Model {
    ...
    function get_notifications($notification_type='') {
        ...
        $sql = "select A.*, B.p_id, B.manufacturer_id, B.confirm_from_date, B.confirm_to_date, B.p_status, 
                    B.batch_master, B.production_details, B.bar_conversion, B.depot_transfer, 
                    B.documents_upload, B.raw_material_recon, B.report_approved, C.depot_name 
