...
NO. EMP ABSENT</th>
			...
			<tbody style="border:1px solid #000;
							...
							if(count($data)>0) {
								...
								{
									$tbody.= '<tr>
										<td style="border-right: 1px solid #000;text-transform:uppercase;font-weight:bold; border-bottom: 1px solid #000;text-align: left;">'.$data[$i]->zone.'</td>
										<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;text-align: right;">'.$data[$i]->present_count.'</td>
										<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;text-align: right;">'.$data[$i]->absent_count.'</td>
										<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;text-align: right;">'.($data[$i]->absent_count+$data[$i]->present_count).'</td>
										<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;text-align: right;">'.$data[$i]->on_time_count.'</td>
										<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;text-align: right;">'.$data[$i]->late_mark_count.'</td>
										</tr>'; 
								}
							}					
           ...
           <table  class="body_table" style="border-collapse: collapse;width:100%;border:1px solid #000!important;;">
			<thead>
				<tr style=" background-color:yellow ;border-bottom: 1px solid #000;font-weight: bold;">
				  ...
				  <th width="300" style="border-right: 1px solid #000;padding:0 8px;text-align:left;width:300px">NAME OF ABSENT EMP</th>
			...
			<tbody style="border:1px solid #000;background-color: #fff;color: #000;">';
				if(count($absent_data)>0) {
					...
					{
						$tbody.= '<tr>
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">'.$absent_data[$i]->sales_rep_name.'</td>
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">'.$absent_data[$i]->zone.'</td>
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">Absent</td>
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">'.$absent_data[$i]->remark.'</td>
							</tr>'; 
					}
				}		
			'<tr>
           ...
           <table  class="body_table" style="border-collapse: collapse;width:100%;border:1px solid #000!important;;">
			...
			<tbody style="border:1px solid #000;background-color: #fff;color: #000;">';
				if(count($data)>0) {
					...
					{
						$tbody.= '<tr>
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">'.$data[$i]->user_name.'</td>
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">'.$data[$i]->email_id.'</td>
							
							<td style="border-right: 1px solid #000;border-bottom: 1px solid #000;">'.$data[$i]->date.'</td>
							</tr>'; 
					}
				}		
