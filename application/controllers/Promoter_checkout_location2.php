        ...
        // for($i=0; $i<count($data); $i++){
            ...
            if(count($loc_data)>0){
                ...
                for($j=0; $j<count($loc_data); $j++){
                    ...
                    $tr = $tr . '<td style="text-align:center;">'.$loc_data[$j]->timediff.'</td>';
                ...
                $message = '<html><head></head><body>Hi,<br /><br />
                            ...
                            <br />Thanks</body></html>';
                $to_email = 'anish.oberoi@eatanytime.in,rishit.sanghvi@otbconsulting.co.in,swapnil.darekar@otbconsulting.co.in;shailesh.kanathe@eatanytime.in';
                $bcc="dhaval.maru@otbconsulting.co.in";
        ...
        // for($i=0; $i<count($data); $i++){
            ...
            if(count($loc_data)>0){
                ...
                $message = '<html><head></head><body>Hi,<br /><br />
                            ...
                            <br />Thanks</body></html>';
                $to_email = 'rishit.sanghvi@otbconsulting.co.in,anish.oberoi@eatanytime.in,swapnil.darekar@otbconsulting.co.in;shailesh.kanathe@eatanytime.in';
                $bcc="dhaval.maru@otbconsulting.co.in";
                // $to_email = 'dhaval.maru@otbconsulting.co.in';
                // $to_email = 'dhaval.maru@otbconsulting.co.in';
                $mailSent=send_email($from_email,  $from_email_sender, $to_email, $subject, $message, $bcc);
