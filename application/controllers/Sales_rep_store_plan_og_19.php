            ...
            if($result[0]->r_view == 1 || $result[0]->r_edit == 1) {
                ...
                if($get_channel_type=='GT'){
                    ...
                    else
                    {
                        ...
                        case When mangoginger_bar IS NOT NULL and mangoginger_bar!=0 Then CONCAT(mangoginger_bar,'_Bar') ELSE CONCAT(mangoginger_box,'_Box') end as mangoginger,
                        case When berry_blast_bar IS NOT NULL and berry_blast_bar!=0 Then CONCAT(berry_blast_bar,'_Bar') ELSE CONCAT(berry_blast_box,'_Box') end as berry_blast,
                        case When chyawanprash_bar IS NOT NULL and chyawanprash_bar!=0 Then CONCAT(chyawanprash_bar,'_Bar') ELSE CONCAT(chyawanprash_box,'_Box') end as chyawanprash,chocolate_cookies_box,cranberry_orange_box,dark_chocolate_cookies_box,fig_raisins_box,papaya_pineapple_box,variety_box,cranberry_cookies_box,sales_rep_loc_id from  sales_rep_distributor_opening_stock Where sales_rep_loc_id=$sales_rep_loc_id")->result_array();
                    $this->db->last_query();
                    $data['stock_detail']=$result[0];
                    }
