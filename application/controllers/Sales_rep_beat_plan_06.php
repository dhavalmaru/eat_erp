           ...
           <table  class="body_table" style="border-collapse: collapse;width:100%">
			<thead>
				<tr style=" background-color: #f3f3f3 ;border-bottom: 1px solid #ddd;font-weight: bold;">
				  ...
				  <th width="350" style="border-right: 1px solid #ddd;padding: 8px;text-align:left;width:350px">Name Of Employee</th>
					...
					for($i=0; $i<count($data); $i++){
						...
						{						
								...
								$tbody.= ' <tr>
									...
									<td style="border-right: 1px solid #ddd;padding: 8px;text-align: left;color:#222">'.$productivity. '</td>
									</tr>';
						  }
					}
				}
