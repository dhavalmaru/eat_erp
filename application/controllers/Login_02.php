...
class Login extends CI_Controller
{
    ...
    public function check_credentials() {
		...
		if(get_cookie('email')!=NULL || get_cookie('password')!='')
		{
			 ...
			 $query=$this->db->query("SELECT A.id,A.emp_code,A.email_id,A.first_name,A.last_name,A.role_id,A.sales_rep_id,B.sr_type FROM user_master A left outer join sales_rep_master B on B.id=A.sales_rep_id WHERE A.email_id = '$uname' AND A.password = '$upass'");
				$result=$query->result();
