           ...
           for($i=2;$i<=$highestrow;$i++)
            {
                ...
                $sql = "select K.*,L.store_name from(select I.*,j.sales_rep_name from 
                        ...
                        left join (select * from sales_rep_master)j on j.id=I.reporting_manager_id)K 
                    ...
                    if(count($result)>0)
                    {
                        ...
                        $sales_rep_id = $result[0]->reporting_manager_id;
