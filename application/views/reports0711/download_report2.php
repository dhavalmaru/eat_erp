										  ...
										  <div class="col-md-6  col-sm-6 col-xs-12">
											...
											<div class="col-md-6  col-sm-6 col-xs-12">                                                                  
												<div class="input-group" style="display:block">
                                                    <input type="text" class="form-control datepicker" id="from_date" name="from_date" value="<?php echo date('d/m/Y')?>">
            ...
            $('#view_report').click(function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var camt=0;
                        var camttd=0;
                        var datatable="<table><thead><th>Ref Date</th><th>Reference</th><th>Debit</th><th>Credit</th></thead><tbody>";
                        $.each($.parseJSON(data), function(){
                            ...
                            // alert(this.ref_date);
                            datatable=datatable+"<tr><td>"+this.ref_date+"</td><td>"+this.reference+"</td><td>"+debit_amount+"</td><td>"+credit_amount+"</td></tr>";
                        ...
                        datatable=datatable+"<tr><td></td><td></td><td>"+damt+"</td><td>"+camt+"</td></tr>";
                        var diff=0;
                        if(damt>camt) {
                            diff=parseFloat(damt-camt).toFixed(2);
                            datatable=datatable+"<tr><td></td><td></td><td></td><td>"+diff+"</td></tr>";
                        }
                        if(camt>damt) {
                            diff=parseFloat(camt-damt).toFixed(2);
                            datatable=datatable+"<tr><td></td><td></td><td>"+diff+"</td><td></td></tr>";
                        }
