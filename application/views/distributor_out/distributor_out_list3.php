    		...
    		<div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
    			...
    			<div class="heading-h3"> 
    				...
    				<div class="heading-h3-heading mobile-head">
                        ...
                        <div class="pull-right btn-margin" style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?><?php if($status=='pending_for_delivery' || $status=='gp_issued' || $status=='delivered_not_complete') echo 'display: none;';?>">
    										...
    										<table id="customers10" class="table datatable table-bordered"  >
    											...
    											<tbody>
    												...
    												<tr>
    													...
    													<td><?php if($status=='pending_for_delivery' || $status=='gp_issued') { ?><?php echo (($data[$i]->date_of_processing!=null && $data[$i]->date_of_processing!='')?date('d/m/Y',strtotime($data[$i]->date_of_processing)):''); ?><?php } else { ?>
                                                            <a href="<?php echo base_url().'index.php/distributor_out/edit/'.$data[$i]->d_id; ?>"><?php echo (($data[$i]->date_of_processing!=null && $data[$i]->date_of_processing!='')?date('d/m/Y',strtotime($data[$i]->date_of_processing)):''); ?></a><?php } ?>
                                                        </td>
														...
														<td><?php echo $data[$i]->delivery_status; ?></td>
