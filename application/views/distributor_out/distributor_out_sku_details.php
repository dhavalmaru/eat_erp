                                                    ...
                                                    <?php 
                                                        ...
                                                        for($i=0;$i<count($data);$i++) {
                                                            ...
                                                            if($invoice_no!=$previous_invoice_no){ 
                                                                ...
                                                                $previous_invoice_no = $data[$i]->invoice_no;
                                                                $j=1;
                                                            }
                                                    ?>
                                                        <tr class="batch_no">
                                                            ...
                                                            <td>
                                                                <?php echo ((strtoupper(trim($data[$i]->distributor_name))=='DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='AMAZON DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='EAT ANYTIME DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='SHOPCLUES DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='NYKAA DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='HEALTHIFYME WELLNESS PRIVATE LIMITED' || strtoupper(trim($data[$i]->distributor_name))=='1MG TECHNOLOGIES PRIVATE LIMITED' || strtoupper(trim($data[$i]->distributor_name))=='PAYTM DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='UNFACTORY DIRECT' || strtoupper(trim($data[$i]->distributor_name))=='EMBRACE DIRECT')? $data[$i]->distributor_name . '-' . $data[$i]->client_name : $data[$i]->distributor_name); ?>
                                                            </td>
                                                            <td>
