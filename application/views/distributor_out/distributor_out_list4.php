    										...
    										<table id="customers10" class="table datatable table-bordered"  >
    											...
    											<tbody>
    												...
    												<tr>
    													...
    													<td><?php if($status=='pending_for_delivery' || $status=='gp_issued' || $status=='pending_for_approval') { ?><?php echo (($data[$i]->date_of_processing!=null && $data[$i]->date_of_processing!='')?date('d/m/Y',strtotime($data[$i]->date_of_processing)):''); ?><?php } else { ?>
