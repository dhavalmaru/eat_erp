        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   ...
                   <div class="heading-h3-heading mobile-head">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Area List  </div>						 
					  ...
					  <div class="pull-right btn-margin">	
                    	...
                    	<div class="pull-right btn-margin"  style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
									<a class="btn btn-success  " href="<?php echo base_url() . 'index.php/area/add'; ?>">
								...
								<table id="customers2" class="table datatable table-bordered" >
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align:center; vertical-align: middle; "><a href="<?php echo base_url().'index.php/area/edit/'.$data[$i]->id; ?>"><i class="fa fa-edit"></i></a></td>
