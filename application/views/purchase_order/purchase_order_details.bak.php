    ...
    <body>								
                                       ...
                                       <div class="table-stripped form-group" style="padding:15px;" >
                                        ...
                                        <thead>
                                            <tr>
                                              ...
                                              <th width="180">HSN Code  <span class="asterisk_sign">*</span></th>
												<th>CGST(In Rs)</th>
                                                <th>SGST(In Rs)</th>
                                                <th>IGST(In Rs)</th>
                                        ...
                                        <?php $i=0; if(isset($purchase_order_items)) {
                                            ...
                                            <tr id="box_<?php echo $i; ?>_row">
                                                ...
                                                <td>
												 ...
												 <td>
                                                    <input type="text" class="form-control rate" name="hsn_code[]" id="hsncode_<?php echo $i; ?>" placeholder="HSN Code" value="<?php if (isset($purchase_order_items)) { echo $purchase_order_items[$i]->hsn_code; } ?>"/>
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control cgst" name="cgst[]" id="cgst_<?php echo $i; ?>" placeholder="CGST" value="<?php if (isset($purchase_order_items)) { echo $purchase_order_items[$i]->cgst; } ?>"/>
                                                </td>
												
													
												
                                                <td>
                                                    <input type="text" class="form-control sgst" name="sgst[]" id="sgst_<?php echo $i; ?>" placeholder="SGST" value="<?php if (isset($purchase_order_items)) { echo $purchase_order_items[$i]->sgst; } ?>"/>
                                                </td>
												
													
												
                                                <td>
                                                    <input type="text" class="form-control igst" name="igst[]" id="igst_<?php echo $i; ?>" placeholder="IGST" value="<?php if (isset($purchase_order_items)) { echo $purchase_order_items[$i]->igst; } ?>"/>
                                                </td>
                                        ...
                                        <?php }} else { ?>
                                            <tr id="box_<?php echo $i; ?>_row">
                                               ...
                                               <td>
                                                    <input type="text" class="form-control hsn_code" name="hsn_code[]" id="hsncode_<?php echo $i; ?>" placeholder="HSN Code" value=""/>
                                                </td>
												...
												<td>
                                                    <input type="text" class="form-control cgst" name="cgst[]" id="cgst_<?php echo $i; ?>" placeholder="CGST" value=""/>
                                                </td>
												
                                                <td>
                                                    <input type="text" class="form-control sgst" name="sgst[]" id="sgst_<?php echo $i; ?>" placeholder="SGST" value=""/>
                                                </td>
												
												
												
                                                <td>
                                                    <input type="text" class="form-control igst" name="igst[]" id="igst_<?php echo $i; ?>" placeholder="IGST" value=""/>
                                                </td>
                                                <td>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                addMultiInputNamingRules('#form_purchase_order_details', 'input[name="hsn_code[]"]', { required: true, number: true }, "");
            ...
            jQuery(function(){
                ...
                $('#repeat-box').click(function(event){
                    ...
                    var newRow = jQuery('<tr id="box_'+counter+'_row">' + 
                                            ...
                                            '<td>' + 
                                                '<input type="text" class="form-control hsn_code" name="hsn_code[]" id="hsncode_'+counter+'" placeholder="HSN Code" value=""/>' + 
                                            '</td>' + 
                                            ...
                                            '<td>' + 
                                                '<input type="text" class="form-control cgst" name="cgst[]" id="cgst_'+counter+'" placeholder="CGST" value=""/>' + 
                                            '</td>' + 
											
											 '<td>' + 
                                                '<input type="text" class="form-control sgst" name="sgst[]" id="sgst_'+counter+'" placeholder="SGST" value=""/>' + 
                                            '</td>' + 
											
											 '<td>' + 
                                                '<input type="text" class="form-control Igst" name="Igst[]" id="Igst_'+counter+'" placeholder="IGST" value=""/>' + 
                                            '</td>' + 
                    ...
                    removeMultiInputNamingRules('#form_purchase_order_details', 'input[alt="rate[]"]');
					   removeMultiInputNamingRules('#form_purchase_order_details', 'input[alt="hsn_code[]"]');
					      removeMultiInputNamingRules('#form_purchase_order_details', 'input[alt="cgst[]"]');
					
                    removeMultiInputNamingRules('#form_purchase_order_details', 'input[alt="sgst[]"]');
					   removeMultiInputNamingRules('#form_purchase_order_details', 'input[alt="igst[]"]');
