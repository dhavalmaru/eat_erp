...
<body>
    <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:925px; margin:auto; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:14px; font-weight:400; border:1px solid #666;"    >
        ...
        <tr valign="top" style="border: none;">
            ...
            <td width="130" valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($items[$i]->qty,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($items[$i]->rate,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($items[$i]->amount,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($items[$i]->cgst_amt,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($items[$i]->sgst_amt,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($items[$i]->igst_amt,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo  format_money ($items[$i]->total_amt,2); ?></p></td>
        </tr>
        <?php }} ?>       
        <tr valign="top" style="border: none;">
        ...
        ?>
         <tr>
            ...
            <td  valign="top" style="border-left:1px solid #666;"> Other Charges -  <?php if (isset($other_charges)) echo format_money($other_charges,2); ?></td>
            <td  colspan="6" ></td>
            <td style=" font-size:14px; font-weight:500;"   >  <span style="text-align:left; float:left"> &#8377; </span> <span style="text-align:right; float:right"><?php if (isset($other_charges_amount)) echo format_money($other_charges_amount,2); ?></span> </td>
        </tr>
        <?php } ?>
        <tr>
            <!-- <td colspan="3" valign="top" style="padding:0;">&nbsp;</td> -->
            <td colspan="8" valign="top" style="font-size:14px; font-weight:500;"> TOTAL</td>
            <td style=" font-size:14px; font-weight:500;"   >  <span style="text-align:left; float:left"> &#8377; </span> <span style="text-align:right; float:right"><?php if (isset($total_amount)) echo format_money($total_amount,2); ?></span> </td>
        </tr>
        <tr>
					...
					<tr valign="center" >
						...
						echo ' ';else echo 'display:none;';?>">
						 <b> Modified By:</b>
						  ...
						  <b> Approved By:</b>
						  <?php if(isset($approvedby)) echo $approvedby; ?>
