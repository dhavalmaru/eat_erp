										...
										<tr>
											...
											<td>
                                                <span style="display:none;">
                                                    <?php echo (($data[$i]->order_date!=null && $data[$i]->order_date!='')?date('Ymd',strtotime($data[$i]->order_date)):''); ?>
                                                </span>
                                                <a href="<?php echo base_url().'index.php/purchase_order/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->order_date!=null && $data[$i]->order_date!='')?date('d/m/Y',strtotime($data[$i]->order_date)):''); ?></a>
                                            </td>
