...
.thumbnail-wrapper.d32.circular.b-white.user_reg
		{
		margin-bottom: -61px!important;
		/*margin-right: 112px!important;*/
		border: 2px #E0E0E7 solid;
		}
  ...
  .modal {
	...
	.logout-section.aaa
	{
	 ...
	 .logout-section.aaa a {
	color:  #0d3553; 
    font-size: 20px;
    padding: 13px 15px;
    display: block;
    float: left;
    border-left: 1px solid #0d3553;
}
</style>    
...
<div class="header-fixed-style"  >
  ...
  <div class="logo-container">  
	...
	<div class="logout-section aaa" style="padding:0px !important;">
      ...
      <a class="mb-control" data-box="#message-box-success" href="#" style=""> 
        <i class="fa fa-cog" aria-hidden="true"></i><span class="xn-text"> </span>
      </a>
  ...
  <div class="dropdown-selector">
    ...
    <div class="dropdown-selector-left">
									...
									<div class="thumbnail-wrapper d32 circular b-white  user_reg" id="contact1" style=" ">
											<div class="bg-master text-center text-white" style=" background: #0073b7 !important;text-align: center; -size:28pxalign-items:center;text-align: center;font-size:30px;"><span><?php if(isset($userdata['first_name'])) {echo substr($userdata['first_name'], 0, 1);} if(isset($userdata['last_name'])) {echo substr($userdata['last_name'], 0, 1);} ?></span>
											</div>  
									</div>
