    ...
    <body>								
                        ...
                        <form id="form_depot_transfer_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/depot_transfer/update/' . $data[0]->id; else echo base_url().'index.php/depot_transfer/save'; ?>">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <input type="hidden" name="prev_depo" id="prev_depo" value="<?php if(isset($data)) { echo  $data[0]->depot_in_id; } ?>"/>
                            ...
                            <div class="panel-footer">
                                <?php 
                                    ...
                                    if($action==''){
                                        $action = base_url().'index.php/depot_transfer';
                                    }
                                ?>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#depot_in_id").change(function () { 

                    var check_bar_qty = get_bar_qty('depot_transfer','form_depot_transfer_details','depochange'); 
                    var check_box_qty = get_box_qty('depot_transfer','form_depot_transfer_details','depochange');
                    var check_raw_material_qty = get_raw_material_qty('depot_transfer','form_depot_transfer_details','depochange');
                   

                    if(check_bar_qty==false || check_box_qty==false || check_raw_material_qty==false)
                    {
                        var previous_val = $("#prev_depo").val();
                        $("#depot_in_id").val(previous_val);
                    }
                    else
                    {
                ...
                $('.delete_row_new').click(function(event){
                     set_stock_validation('depot_transfer','form_depot_transfer_details',$(this));
                });
...
var  set_stock_validation = function(model_name,form_name,elem) {
        ...
        if($('#id').val()!='')
        {
            ...
            else if(type=='Bar')
            {
                ...
                var data  = 'id='+$("#id").val()+'&module='+module+'&depot_id='+depot_id+'&product_id='+bar+'&qty='+qty+'&get_stock=1';
            ...
            else
            {
                ...
                var data =  'id='+$("#id").val()+'&module='+module+'&depot_id='+depot_id+'&raw_material_id='+raw_material+'&qty='+qty+'&get_stock=1';
