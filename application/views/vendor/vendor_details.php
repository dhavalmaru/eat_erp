         ...
         <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/Vendor'; ?>" > Vendor List </a>  &nbsp; &#10095; &nbsp; Vendor Details</div>
                   ...
                   <div class="page-content-wrap">
					...
					<div class="main-container">           
                         <div class="box-shadow"> 
                            <form id="form_vendor_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/vendor/update/' . $data[0]->id; else echo base_url().'index.php/vendor/save'; ?>">
								...
								<div class="panel-body">
									<div class="form-group"  >
										<div class="col-md-12 col-sm-12 col-xs-12">
											<label class="col-md-2 col-sm-2 col-xs-12 control-label">Vendor Name <span class="asterisk_sign">*</span></label>
									...
									<div class="h-scroll">	
                                       <div class="table-stripped form-group" style="padding:15px;" >
                                        ...
                                        <?php $i=0; if(isset($vendor_contacts)) {
                                                for($i=0; $i<count($vendor_contacts); $i++) { ?>
                                            <tr id="box_<?php echo $i; ?>_row">
                                                <td>
                                                    <input type="text" class="form-control contact_person" name="contact_person[]" id="contact_person_<?php echo $i; ?>" placeholder="Contact Person" value="<?php if (isset($vendor_contacts)) { echo $vendor_contacts[$i]->contact_person; } ?>"/>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control email_id" name="email_id[]" id="email_id_<?php echo $i; ?>" placeholder="Email Id" value="<?php if (isset($vendor_contacts)) { echo $vendor_contacts[$i]->email_id; } ?>"/>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control mobile" name="mobile[]" id="mobile_<?php echo $i; ?>" placeholder="Mobile" value="<?php if (isset($vendor_contacts)) { echo $vendor_contacts[$i]->mobile; } ?>"/>
                                                </td>
                                    ...
                                    <div class="form-group" style="<?php if(isset($data)) echo ''; else echo 'display: none;';?>">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <!-- <label class="col-md-2 col-sm-2 col-xs-12 control-label">Contact Person <span class="asterisk_sign">*</span></label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="panel-footer">
									<a href="<?php echo base_url(); ?>index.php/vendor" class="btn btn-danger" type="reset" id="reset">Cancel</a>
