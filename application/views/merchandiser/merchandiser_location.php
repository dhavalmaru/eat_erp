...
<div class="contact app-pages app-section" style="margin:50 auto">
	<div class="container">
            ...
            <div class="app-title">
				<h5>Order Details</h5>
                  ...
                  <hr>
                    ...
                    <form id="form_merchendizer_location_details" role="form" class="" method="post" enctype="multipart/form-data" action="<?php if (isset($data[0]->mid)) echo base_url(). 'index.php/merchandiser_location/save/' . $data[0]->mid; else echo base_url().'index.php/merchandiser_location/save'; ?>">
        ...
        <script>
			...
			jQuery(function(){
                var counter = $('.mango').length;
                
                $('#repeat-bar-6').click(function(event){
                    event.preventDefault();
                    //$('#box_details').remove(newRow1);
                    var newRow = jQuery('<div class="col s12" id="mango_'+counter+'_row" style="padding-bottom: 3px;">' + 
                                            '<div class="input-field col s4">'  +' Mango Bar'+ 
                                                    '<input type="hidden" name="bar[]" id="mango_'+counter+'"  value="6" >'+
                                            '</div>' + 
                                            '<div class="input-field col s4">' + 
                                                '<input type="text" name="qty[]" id="qty_6_'+counter+'"  value="" placeholder="Available Stock" />' + 
                                            '</div>' + 
                                         
                                            '<div class= "input-field col s3">' + 
                                                '<select name="batch_no[]" id="batch_no_6_'+counter+'" class="browser-default">' + 
                                                    '<option value="">Select</option>' + 
                                                    '<?php for ($k=0; $k < count($batch) ; $k++) { ?>' + 
                                                            '<option value="<?php echo $batch[$k]->id; ?>"><?php echo $batch[$k]->batch_no; ?></option>' + 
                                                    '<?php } ?>' + 
                                                '</select>' + 
                                            '</div>' + 
                                            '<a id="mango_'+counter+'_row_delete" class="delete_row" href="#"><span class="fa trash fa-trash-o"  ></span></a>' + 
                                        '</div>');
                    $('#bar_details6').append(newRow);
                    $('.delete_row').click(function(event){
                        delete_row($(this));
                    });
                    counter++;
			...
			jQuery(function(){
                var counter = $('.variety').length;
                
                $('#repeat-bar-variety').click(function(event){
                    event.preventDefault();
                    //$('#box_details').remove(newRow1);
                    var newRow = jQuery('<div class="col s12" id="variety_'+counter+'_row" style="padding-bottom: 3px;">' + 
                                            '<div class="input-field col s4">'  +'Variety Box'+ 
                                                    '<input type="hidden" name="bar[]" id="variety_'+counter+'"  value="17" >'+
                                            '</div>' + 
                                            '<div class="input-field col s4">' + 
                                                '<input type="text" name="qty[]" id="qty_01_'+counter+'"  value="" placeholder="Available Stock" />' + 
                                            '</div>' + 
                                            ...
                                            '<div class= "input-field col s3">' + 
                                                ...
                                                '</select>' + 
                                            '</div>' + 
                                            '<a id="variety_'+counter+'_row_delete" class="delete_row" href="#"><span class="fa trash fa-trash-o"  ></span></a>' + 
                                        '</div>');
                    $('#bar_details7').append(newRow);
                    $('.delete_row').click(function(event){
                        delete_row($(this));
                    });
                    counter++;
                ...
                $('#repeat-bar_image').click(function(event){
                    ...
                    var newRow = jQuery('<tr id="bar_image_'+counter+'_row">'+
                                          '<td class=" input-field">'+
                                                '<input type="text" class="form-control title" name="title[]" id="title_'+counter+'" placeholder="title" value=""/>'+
                                            '</td>'+
                                            '<td>'+
