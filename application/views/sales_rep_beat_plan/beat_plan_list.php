        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   ...
                   <div class="heading-h3-heading mobile-head">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Sales Representative Beat Plan List <a class="btn btn-default-danger pull-right "  style="margin-right:8px!important;" href="<?php echo base_url('index.php/Sales_rep_beat_plan/download_csv');?>" ><i class="fa fa-file-pdf-o "></i> Download Sample</a> </div>						 
					  ...
					  <div class="pull-right btn-margin">	
                       	...
                       	<!-- <div class="pull-right btn-margin" style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
									<a class="btn btn-success " href="<?php echo base_url() . 'index.php/Sales_rep_beat_plan/add'; ?>">
										<span class="fa fa-plus"></span> Add Sales Representative Beat Plan
									</a>
					  ...
					  <div class="page-width">	
                        <div class="col-md-12">
                            <div class="pull-right btn-margin" style="padding-bottom:20px"> 
                                <a class="btn btn-success" href="<?php echo base_url('index.php/Sales_rep/retailer_not_mapped');?>">
                                    <span class="fa fa-file-excel-o"></span> Retailers
                                </a> 
                              
                                <a class="btn btn-success" href="<?php echo base_url('index.php/Sales_rep/sales_rep_not_mapped');?>">
                                    <span class="fa fa-file-excel-o"></span> Sales Rep Not Mapped
                                </a> 
                                
                                <a class="btn btn-success" href="<?php echo base_url('index.php/Sales_rep/zone_not_mapped');?>">
								...
								<table id="customers2" class="table datatable table-bordered"  >
									<thead>
										<tr>
											...
											<th width="120"> Sales Representative Name</th>
				...
				<div class="modal fade" id="myModal" role="dialog" style="">
                    ...
                    <div class="modal-content" style="">
                        ...
                        <form method="POST" action="<?php echo base_url();?>index.php/Sales_rep_beat_plan/upload_file" class="form-horizontal excelform" enctype="multipart/form-data">
