       ...
       <!-- START PAGE CONTAINER -->
                                       ...
                                       <div class="table-stripped form-group" style="padding:15px;" >
                                        ...
                                        <?php $i=0; if(isset($distributor_in_items)) {
                                            ...
                                            <tr id="box_<?php echo $i; ?>_row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control total_amount1" name="total_amount1[]" id="total_amount1_<?php echo $i; ?>" placeholder="Amount" value="" readonly />
                                                </td>
                                                <td style="display: none;">
                                                    <input type="text" class="form-control cost_total_amount1" name="cost_total_amount1[]" id="cost_total_amount1_<?php echo $i; ?>" placeholder="Total Amount" value="<?php if (isset($distributor_in_items)) { echo $distributor_in_items[$i]->cost_amount; } ?>" readonly />
                                                </td>
                                        ...
                                        <?php }} else { ?>
                                            <tr id="box_<?php echo $i; ?>_row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control total_amount1" name="total_amount1[]" id="total_amount1_<?php echo $i; ?>" placeholder="Total Amount" value="" readonly />
                                                </td>
                                                <td style="display: none;">
                                                    <input type="text" class="form-control cost_total_amount1" name="cost_total_amount1[]" id="cost_total_amount1_<?php echo $i; ?>" placeholder="Total Amount" value="" readonly />
                                                </td>
                                                <td style="text-align:center;     vertical-align: middle;">
                                                    <a id="box_<?php echo $i; ?>_row_delete" class="delete_row" href="#"><span class="fa trash fa-trash-o"  ></span></a>
                                                </td>
                                       ...
                                       <div class="table-stripped form-group" style="padding:15px;" >
                                        ...
                                        <?php $i=0; if(isset($distributor_in_items_ex)) {
                                            ...
                                            <tr id="box_<?php echo $i; ?>_row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control total_amount1_ex" name="total_amount1_ex[]" id="total_amount1_ex_<?php echo $i; ?>" placeholder="Amount" value="" readonly />
                                                </td>
                                                <td style="display: none;">
                                                    <input type="text" class="form-control cost_total_amount1_ex" name="cost_total_amount1_ex[]" id="cost_total_amount1_ex_<?php echo $i; ?>" placeholder="Total Amount" value="<?php if (isset($distributor_in_items_ex)) { echo $distributor_in_items_ex[$i]->cost_amount; } ?>" readonly />
                                                </td>
                                        ...
                                        <?php }} else { ?>
                                            <tr id="box_<?php echo $i; ?>_row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control total_amount1_ex" name="total_amount1_ex[]" id="total_amount1_ex_<?php echo $i; ?>" placeholder="Total Amount" value="" readonly />
                                                </td>
                                                <td style="display: none;">
                                                    <input type="text" class="form-control cost_total_amount1_ex" name="cost_total_amount1_ex[]" id="cost_total_amount1_ex_<?php echo $i; ?>" placeholder="Total Amount" value="" readonly />
                                                </td>
                                                <td style="text-align:center;     vertical-align: middle;">
        ...
        <script type="text/javascript">
            ...
            function get_amount(elem){
                ...
                var total_amount1 = parseFloat(cst_amt1+amount);
                $("#total_amount1_"+index).val((total_amount1).toFixed(2));

                $("#cost_total_amount1_"+index).val((cost_amount).toFixed(2));
            ...
            function get_amount_ex(elem){
                ...
                var total_amount1 = parseFloat(cst_amt1+amount);
                $("#total_amount1_ex_"+index).val((total_amount1).toFixed(2));

                $("#cost_total_amount1_ex_"+index).val((cost_amount).toFixed(2));
            ...
            function get_total(){
                ...
                $('.cost_total_amount1').each(function(){
            ...
            function get_total_ex(){
                ...
                $('.total_amount1_ex').each(function(){
                    totamt = parseFloat(get_number($(this).val(),2));
                    if (isNaN(totamt)) totamt=0;
                    tot_amt = tot_amt + totamt;
                });

                $('.cost_total_amount1_ex').each(function(){
                    costtotamt = parseFloat(get_number($(this).val(),2));
                    if (isNaN(costtotamt)) costtotamt=0;
                    cost_tot_amt = cost_tot_amt + costtotamt;
                });
            ...
            $(document).ready(function(){
                ...
                $.each($('.total_amount1'), function(i, item) {
                    ...
                    if(isNaN(totamt1) || totamt1==0) {
                        totamt1=0;
                        $('#total_amount1_'+i).val(totamt1);
                    }
                    else {
                        $('#total_amount1_'+i).val(totamt1.toFixed(2));
                    }
                    // alert(totamt1);
                });
                ...
                $.each($('.total_amount1_ex'), function(i, item) {
                    var amount =  parseFloat($('#amount_ex_'+i).val());
                    var cst = parseFloat($('#vat1_ex_'+i).val());
                    var totamt1=parseFloat(amount+cst);
                    if(isNaN(totamt1) || totamt1==0) {
                        totamt1=0;
                        $('#total_amount1_ex_'+i).val(totamt1);
                    }
                    else {
                        $('#total_amount1_ex_'+i).val(totamt1.toFixed(2));
                    }
                    // alert(totamt1);
                });
            ...
            jQuery(function(){
                ...
                $('#repeat-box').click(function(event){
                    ...
                    var newRow = jQuery('<tr id="box_'+counter+'_row">' + 
                                            ...
                                            '</td>' + 
                                            '<td>' + 
                                                '<input type="text" class="form-control total_amount1" name="total_amount1[]" id="total_amount1_'+counter+'" placeholder="Total Amount" value="" readonly />' + 
                                            '</td>' + 
                                            '<td style="display: none;">' + 
                                                '<input type="text" class="form-control cost_total_amount1" name="cost_total_amount1[]" id="cost_total_amount1_'+counter+'" placeholder="Cost Total Amount" value="" readonly />' + 
                                            '</td>' + 
                                            '<td style="text-align:center;">' + 
                ...
                $('#repeat-box_ex').click(function(event){
                    ...
                    var newRow = jQuery('<tr id="box_'+counter+'_row">' + 
                                            ...
                                            '</td>' + 
                                            '<td>' + 
                                                '<input type="text" class="form-control total_amount1_ex" name="total_amount1_ex[]" id="total_amount1_ex_'+counter+'" placeholder="Total Amount" value="" readonly />' + 
                                            '</td>' + 
                                            '<td style="display: none;">' + 
                                                '<input type="text" class="form-control cost_total_amount1_ex" name="cost_total_amount1_ex[]" id="cost_total_amount1_ex_'+counter+'" placeholder="Cost Total Amount" value="" readonly />' + 
                                            '</td>' + 
                                            '<td style="text-align:center;">' + 
