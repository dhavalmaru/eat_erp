							...
							<div class="col-md-4 col-sm-4 col-xs-12" <?php if(isset($rep_grp_2)) {if($rep_grp_2==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body list-group">
                                                ...
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/27'?>" id="report_2" class="list-group-item-reports" ><span class="fa fa-external-link"></span> Raw Material IN/Out Stock </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/26'?>" id="report_2" class="list-group-item-reports" ><span class="fa fa-external-link"></span>Distributor Transfer Report </a>
							...
							<div class="col-md-4 col-sm-4 col-xs-12" <?php if(isset($rep_grp_4)) {if($rep_grp_4==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
                                ...
                                <div class="panel panel-success">
                                    <div class="panel-body list-group">
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/22'?>" id="report_22" class="list-group-item-reports" <?php if(isset($rep_22)) {if($rep_22==0) echo 'style="display: none;"';}  ?>><span class="fa fa-external-link"></span> Screen Load Time </a>

                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/25'?>" id="report_25" class="list-group-item-reports" <?php if(isset($rep_13)) {if($rep_13==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> MT Stock Tracker </a>
