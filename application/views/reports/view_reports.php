							...
							<div class="panel-body">  
								<div class="row push-up-10" style="padding:10px;">
									<div class="col-md-4 col-sm-4 col-xs-12" <?php if(isset($rep_grp_1)) {if($rep_grp_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body list-group">
                                                <a style="display:none;" href="<?php echo base_url() . 'index.php/export/set_report_criteria/1'?>" id="report_1" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Sale Invoice </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/18'?>" id="report_18" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Sales Report </a>
                                                <a style="display:none;" href="<?php echo base_url() . 'index.php/export/set_report_criteria/19'?>" id="report_19" class="list-group-item-reports" <?php if(isset($rep_18_view)) {if($rep_18_view==1) {if(isset($rep_18)) {if($rep_18==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Sample & Expired SKU </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/31'?>" id="report_31" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Monthly Sales Overview Report </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/32'?>" id="report_32" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Zonewise Monthly Sales Overview Report </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/33'?>" id="report_32" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Beat Plan Analysis Report </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/34'?>" id="report_32" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Daily sales performance report </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/35'?>" id="report_32" class="list-group-item-reports" <?php if(isset($rep_1_view)) {if($rep_1_view==1) {if(isset($rep_1)) {if($rep_1==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Daily Merchandiser performance report </a>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12" <?php if(isset($rep_grp_3)) {if($rep_grp_3==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body list-group">
                                                <a style="display:none;" href="<?php echo base_url() . 'index.php/export/set_report_criteria/8'?>" id="report_8" class="list-group-item-reports" <?php if(isset($rep_8)) {if($rep_8==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Sales Return </a>
                                                ...
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/36'?>" id="report_8" class="list-group-item-reports" <?php if(isset($rep_16)) {if($rep_16==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Sales Summary </a>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12" <?php if(isset($rep_grp_2)) {if($rep_grp_2==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body list-group">
                                                ...
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/27'?>" id="report_2" class="list-group-item-reports" <?php if(isset($rep_2_view)) {if($rep_2_view==1) {if(isset($rep_2)) {if($rep_2==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Raw Material IN/Out Stock </a>
                                                <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/26'?>" id="report_2" class="list-group-item-reports" <?php if(isset($rep_2_view)) {if($rep_2_view==1) {if(isset($rep_2)) {if($rep_2==0) echo 'style="display: none;"';} else echo 'style="display: none;"';}  else echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span>Distributor Transfer Report </a>
							...
							<div class="col-md-4 col-sm-4 col-xs-12" <?php if(isset($rep_grp_4)) {if($rep_grp_4==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
                                ...
                                <div class="panel panel-success">
                                    <div class="panel-body list-group">
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/sales_rep/sales_rep_route_plan'?>" id="report_20" class="list-group-item-reports" <?php if(isset($rep_9)) {if($rep_9==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Sales Representative Route Plan </a>
                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/15'?>" id="report_15" class="list-group-item-reports" <?php if(isset($rep_15)) {if($rep_15==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Promoter Sales </a>
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/sales_rep/sales_rep_location'?>" id="report_21" class="list-group-item-reports" <?php if(isset($rep_9)) {if($rep_9==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span>Promoters Location </a>
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/7'?>" id="report_7" class="list-group-item-reports" <?php if(isset($rep_7)) {if($rep_7==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Distributor Master </a>
                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/9'?>" id="report_9" class="list-group-item-reports" <?php if(isset($rep_9)) {if($rep_9==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Payment Receivables </a>

                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/22'?>" id="report_22" class="list-group-item-reports" <?php if(isset($rep_9)) {if($rep_9==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> Screen Load Time </a>

                                        <a href="<?php echo base_url() . 'index.php/export/set_report_criteria/25'?>" id="report_25" class="list-group-item-reports" <?php if(isset($rep_9)) {if($rep_9==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> MT Stock Tracker </a>
										
										<a href="<?php echo base_url() . 'index.php/export/set_report_criteria/28'?>" id="report_28" class="list-group-item-reports" <?php if(isset($rep_9)) {if($rep_9==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><span class="fa fa-external-link"></span> GT Stock Tracker </a>
