                                        ...
                                        <div class="col-md-6  col-sm-6 col-xs-12">
										   ...
										   <div class="col-md-6  col-sm-6 col-xs-12">
                                            <div class="">
													...
													<input type="radio" name="remark_visibility"  value="With Remark" checked>With Remark
													</label>
													<label class="radio-inline">
														<input type="radio" name="remark_visibility"  value="Without Remark">Without Remark
													</label>
