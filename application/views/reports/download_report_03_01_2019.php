            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                  ...
                  <div class="container">
                      ...
                      <?php } ?>
                       <?php if($this->session->flashdata('adj_message')){?>
                           <div class="alert alert-danger alert-dismissible fade in">
                           <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                           <?php echo rtrim($this->session->flashdata('adj_message'),',');?></div>  
                     <?php } ?>
                  </div>
                    ...
                    <div class="row main-wrapper">                  
                       <div class="main-container">           
                         <div class="box-shadow custom-padding">
						  <form id="form_download_report" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php if(isset($report_id)) { echo base_url().'index.php/export/generate_report/'.$report_id; } ?>" onsubmit="return myFunction(this)">
							
						  <div  style="padding:0;">
                          <div class="box-shadow-inside" style="background: #fff">  
                        <div class="panel panel-default">
							<div class="panel-body panel-group accordion" >
								 ...
								 <div class="panel-body panel-body-open text1" id="accOneColOne" style="width:100%; ">
                                         ...
                                         <div class="col-md-6  col-sm-6 col-xs-12">
                                            <div class="">
                                                ...
                                                <div class="col-md-6 col-sm-6  col-xs-12">
							                      ...
							                      <div class="form-group" style="border-top:1px solid #ddd; border-bottom:none; <?php if( $report_id !='23' ) echo 'display:none;';?>">
                                         <div class="col-md-6  col-sm-6 col-xs-12">
                                            <div class="">
                                    ...
                                    <div class="form-group" style="border-top:1px solid #ddd; border-bottom:none; <?php if($report_id !='24') echo 'display:none;';?>">
                                         <div class="col-md-6  col-sm-6 col-xs-12">
                                            <div class="">
                                                <label class="col-md-4 col-sm-4 col-xs-12  control-label">Select Sales Representative</label>
                                                <div class="col-md-6 col-sm-6  col-xs-12">
                                    ...
                                    <div class="form-group" style="border-top:1px solid #ddd; border-bottom:none; <?php if($report_id !='20') echo 'display:none;';?>">
                                         <div class="col-md-6  col-sm-6 col-xs-12">
                                            <div class="">
                                                ...
                                                <div class="col-md-6 col-sm-6  col-xs-12">
                                                    <input type="radio" name="includes_zero" class='includes_zero' id="includes_zero" 
                                    ...
                                    <div class="form-group" style="border-top:1px solid #ddd; border-bottom:none; <?php if($report_id !='20') echo 'display:none;';?>">
                                         <div class="col-md-6  col-sm-6 col-xs-12">
                                            <div class="">
                                                <label class="col-md-4 col-sm-4 col-xs-12  control-label">Include</label>
                                                <div class="col-md-6 col-sm-6  col-xs-12">
                                                  <input type="radio" name="includes_zero" class='includes_zero' id="includes_zero" value='20'> Less Then 20  Closing Balance<br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div>
                      <table style="width: 100%!important;">
                        ...
                        if(count($upload_telly_report)>0)
                        {
                            ...
                            echo "<tr><td>".($j+1)."</td>
                                  <td><a href='".base_url()."/uploads/excel_upload'>".$upload_telly_report[$i]->file_name."</a></td>
                                  <td><input type='hidden' value='".$upload_telly_report[$i]->telly_report_upload_id."'>".$upload_telly_report[$i]->telly_date."</td>
                ...
                <div class="modal-content" style="">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                          <label class="col-md-4 col-sm-4 col-xs-12 control-label">Telly Date <span class="asterisk_sign"></span></label>
                          <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="text" class="form-control datepicker" name="telly_date" id="telly_date" placeholder="Telly Date" />
                          </div>
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function(){
          ...
          $('#view_tally').click(function(){
            ...
            $.ajax({
                ...
                async:false,
                data: {excel_upload: '', from_date: $('#from_date').val(), to_date: $('#to_date').val()},
                success: function (data) {
