    ...
    <script type="text/javascript">
        ...
        $('.adjusted_time').on('blur' ,function(){
          ...
          $('.adjusted_time').each(function(){
              ...
              else if((currentD > endHappyHourD || (parseInt(effective_time)<9)) && (emp_status!='WeeklyOff' && emp_status!='Absent' && emp_status!='Holiday'))
              {
                 if(parseInt(effective_time)!=0 && (parseInt(effective_time)>=4))
                    {
                      Late_marks = 'H';
                    }
                    else
              ...
              switch (Late_marks) {
                  ...
                  case ('N'):
                       ...
                       {
                         console.log('employee_adjusted_time'+employee_adjusted_time);
                         if(parseInt(effective_time)<4 && (emp_status!='WeeklyOff' && emp_status!='Absent' && emp_status!='Holiday'))
                          {
                            employee_adjusted_time = 0.00;
                          }
                          else
