    ...
    <script type="text/javascript">
        ...
        $('.adjusted_time').on('blur' ,function(){
          ...
          $('.adjusted_time').each(function(){
              ...
              var emp_in = $("#emp_in_"+row_id).text();
              var emp_out = $("#emp_out_"+row_id).text();
              ...
              var effective_time ;
			  // if(emp_status!='Absent' && emp_status!='Holiday' && emp_status!='WeeklyOff')
			  // {
				  // if(emp_in!=in_time || emp_out!=out_time )
			  // {
				  // $("#adjust_log_"+row_id).css('background','#ccddff');
			  // }
			  // }
              switch (emp_status) {
                  case "WeeklyOff":
              ...
              switch (Late_marks) {
                  ...
                  case ('N'):
                       ...
                       else
                       {
                         ...
                         else if(parseInt(effective_time)<4 && (emp_status!='WeeklyOff' && emp_status!='Absent' && emp_status!='Holiday'))
                          {
                            employee_adjusted_time = 0.00;
                          }
                          else
