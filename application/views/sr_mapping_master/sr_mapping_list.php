	...
	<div class="page-container page-navigation-top">            
		...
		<div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
			<div class="heading-h3"> 
				<div class="heading-h3-heading mobile-head">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Sr Mapping List  </div>						 
				<div class="heading-h3-heading mobile-head">
					...
					<div class="pull-right btn-margin"  style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
						<a class="btn btn-success  " href="<?php echo base_url() . 'index.php/sr_mapping/add'; ?>">
							<span class="fa fa-plus"></span> Add Details
						</a>
					</div>
				</div>	      
			</div>	 
										...
										<table id="customers2" class="table datatable table-bordered" >
											...
											<tbody>
												...
												<tr>
													...
													<td>
													<?php if(($data[$i]->distributor_type)=='Modern Trade'||($data[$i]->distributor_type=='E-Commerce'))
													{
													echo $data[$i]->store_name; 
