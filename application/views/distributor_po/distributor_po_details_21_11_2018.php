                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group" >
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="radio" name="delivery_through" id="delivery_through_whpl" value="WHPL" data-error="#err_delivery_through" onChange="get_distributors(this);" <?php if (isset($data)) { if($data[0]->delivery_through=='WHPL') echo 'checked'; } ?> />&nbsp;&nbsp; WHPL &nbsp;&nbsp;
                                                <input type="radio" name="delivery_through" id="delivery_through_distributor" value="Distributor" data-error="#err_delivery_through" onChange="get_distributors(this);" <?php if (isset($data)) { if($data[0]->delivery_through=='Distributor') echo 'checked'; } ?> />&nbsp;&nbsp; Distributor
