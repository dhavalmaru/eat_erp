      ...
      <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
        <div class="heading-h3">
          <div class="heading-h3-heading mobile-head">
            <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Shopify Upload
          </div>
				  <div class="heading-h3-heading mobile-head">
              ...
              <a class="btn btn-default-danger pull-right " style="margin:0px 8px!important;" href="<?php echo base_url().'index.php/shopify/download_upload_format'; ?>" >
                <i class="fa fa-file-excel-o "></i> Download Pending Orders
              </a>
        ...
        <div class="modal fade" id="myModal" role="dialog" style="">
          <div class="modal-dialog">
            <div class="modal-content" style="">
              ...
              <form method="POST" action="<?php echo base_url();?>index.php/shopify/upload_file" class="form-horizontal excelform" enctype="multipart/form-data">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url().'assets/uploads/shopify/'.$data[$i]->file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                              </td>
                              <td>
                                <?php if($data[$i]->error_file_name!=null && $data[$i]->error_file_name!=''){ ?>
                                <a href="<?php echo base_url().'assets/uploads/shopify/'.$data[$i]->error_file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                                <?php } ?>
                              </td>
                              <td>
                                ...
                                <a href="<?php echo base_url().'assets/uploads/shopify/'.$data[$i]->check_file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                                <?php } ?>
                              </td>
                              <td>
                                <?php if($data[$i]->status=='Uploading'){ ?>
                                  <a href="<?php echo base_url();?>index.php/shopify/upload_file_data/<?php echo $data[$i]->id;?>">
                                    <button type="button" class="btn btn-default">Upload Data</button>
                                  </a>
                                <?php } else if($data[$i]->status=='Pending') { ?>
                                  <!-- <a href="<?php // echo base_url();?>index.php/shopify/approve_file_data/<?php // echo $data[$i]->id;?>" style="margin-right: 5px;">
                                    <button type="button" class="btn btn-success">Approve File</button>
                                  </a>
                                  <a href="<?php // echo base_url();?>index.php/shopify/reject_file_data/<?php // echo $data[$i]->id;?>">
                                    <button type="button" class="btn btn-danger">Reject File</button>
                                  </a> -->
                                <?php } else if($data[$i]->status=='Approved') { ?>
                                  <!-- <a href="<?php // echo base_url();?>index.php/shopify/get_file_invoices/<?php // echo $data[$i]->id;?>" style="margin-right: 5px;" target="_blank">
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#customers10').DataTable({
            ...
            "ajax":{
                    url : BASE_URL+'index.php/shopify/get_data/'+status,
                    type: "post",
                    async: false,
                    data: function(data) {       
                        data.status = status;
