               	...
               	<div class="heading-h3"> 
				  	...
				  	<div class="heading-h3-heading mobile-head">
                    	...
                    	<div class="pull-right btn-margin"  style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
							<a class="btn btn-success  " href="<?php echo base_url() . 'index.php/exp_cat_master/add'; ?>">
								<span class="fa fa-plus"></span> Add Expense Category
							</a>
						</div>
			     	</div>	      
                </div>	 
						...
						<div class="panel panel-default">
						 	<div class="panel-body">
								...
								<table id="customers2" class="table datatable table-bordered" >
									<thead>
										<tr>
											<th width="100" style="text-align:center;">Sr. No.</th>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align:center; vertical-align: middle; ">
												<a href="<?php echo base_url().'index.php/exp_cat_master/edit/'.$data[$i]->id; ?>">
