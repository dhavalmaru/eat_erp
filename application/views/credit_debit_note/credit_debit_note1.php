...
<head>
    ...
    <title><?php if(isset($credit_debit_note[0]->transaction)) echo $credit_debit_note[0]->transaction; ?></title>
...
<div class="debit_note">
    ...
    <table class="user_data" border="0" width="100%" style="border-collapse:collapse; " class="table" cellspacing="0">
					<tr valign="bottom" >
						   <td style="font-weight:bold">Created By:</td>
						   <td><?php if(isset($credit_debit_note[0]->createdby)) echo $credit_debit_note[0]->createdby; ?></td>
						   <td style="font-weight:bold">Modified By:</td>
						   <td><?php if(isset($credit_debit_note[0]->modifiedby)) echo $credit_debit_note[0]->modifiedby; ?></td>
						   <td style="font-weight:bold">Approved By:</td>
						   <td><?php if(isset($credit_debit_note[0]->approvedby)) echo $credit_debit_note[0]->approvedby; ?></td>
					</tr>
					<tr valign="bottom" >
					     <td style="font-weight:bold">Created On:</td>
						    <td><?php if(isset($credit_debit_note[0]->created_on)) echo date('d-F-Y',strtotime($credit_debit_note[0]->created_on));?></td>
						   <td style="font-weight:bold">Modified On:</td>
						     <td><?php if(isset($credit_debit_note[0]->modified_on)) echo date('d-F-Y',strtotime($credit_debit_note[0]->modified_on)); ?></td>
						   <td style="font-weight:bold">Approved On:</td>
						     <td><?php if(isset($credit_debit_note[0]->approved_on))echo date('d-F-Y',strtotime($credit_debit_note[0]->approved_on)); ?>
	</div></td>
					</tr>
	</table>
