...
<div>
    <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:1250px; margin: 0 auto; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:12px; font-weight:400; border:1px solid #666; "    >
		...
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  ...
		  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="15%"><?php echo format_money($raw_material_stock[$i]->po_quantity,2); ?></td>
		   <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->po_rate,2); ?></td></td>
		    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money ($raw_material_stock[$i]->po_amount,2); ?></td>
			<td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->po_cgst_amt,2); ?></td>
			 <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->po_sgst_amt,2); ?></td>
		  <td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->po_total_amt,2); ?></td></tr></table>
		</td>
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  <table style="width: 100%;border-spacing: 0; height: 36px;"><tr>
		  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="15%"><?php echo format_money($raw_material_stock[$i]->qty,2); ?></td>
		   <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->rate,2); ?></td></td>
		    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->amount,2); ?></td>
			<td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->cgst_amt,2); ?></td>
			 <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->sgst_amt,2); ?></td>
		  <td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[$i]->total_amt,2); ?></td></tr></table>
		</td>
		...
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  ...
		  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="15%"></td>
		   <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			...
			<td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			 <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
		  <td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo format_money($raw_material_stock[0]->po_other_charges_amount,2); ?></td></tr></table>
		</td>
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  <table style="width: 100%;border-spacing: 0; height: 36px;"><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="15%"></td>
		    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
				  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td><td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php echo  format_money( $raw_material_stock[0]->other_charges_amt,2); ?></td></tr></table>
		</td>
		...
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  ...
		  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="15%"></td>
		   <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			...
			<td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			 <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
		  <td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php if(isset($data)) { echo format_money($data[0]->final_amount,2); } ?></td></tr></table>
		</td>
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  <table style="width: 100%;border-spacing: 0; height: 36px;"><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="15%"></td>
		    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
				  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td><td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"><?php if(isset($data)) { echo format_money($data[0]->final_amount,2); } ?></td></tr></table>
		</td>
