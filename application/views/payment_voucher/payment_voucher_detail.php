                                   ...
                                   <div class="form-group vendor_selection" style="<?php if (isset($data[0]->type)) {
                                      ...
                                      <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label class="col-md-2 col-sm-2 col-xs-12 control-label">Vendor </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                                <select name="vendor_id" id="vendor_id" class="form-control select2" > <option value="">Select</option>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                          <label class="col-md-2 col-sm-2 col-xs-12 control-label">PO No<span class="asterisk_sign">*</span></label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                             ...
                                             id="purchase_order_id" class="form-control select2">
                        ...
                        if(data.result==1){
                            ...
                            for(var i=0; i<data.item_id.length; i++){
                                ...
                                var newRow = jQuery('<tr id="box_'+counter+'_row">'+
                                            ...
                                            '</td>' + 
                                            '<td>' + 
                                            '<input type="text" class="form-control rate" name="tax[]" id="tax_per_'+counter+'" placeholder="Tax %" value="'+tax_per+'" onblur="get_amount(this)"   onkeypress="return isNumberKey(event)" readonly/>'+
                                            '</td>' +  
                                            '<td class="print_hide">' + 
