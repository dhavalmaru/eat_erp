...
<div>
            ...
            <table width="100%" border="0" cellspacing="0">
                <tr>
                    ...
                    <td width="60%" style="color:#808080; text-align:center;">
                        <h1 style="padding:0; margin:0;text-align: center; font-size:22px;">Payment Voucher </h1>
                    </td>
    ...
    <tr style="border-top: 1px solid #666;">
      <td colspan="2" valign="top" style="padding:20px 5px;vertical-align:top;">
             <p style="margin:0;text-align:left;line:height:22px;font-weight:bold; ">Journal Voucher No</p> 
            
      </td>   
      <td colspan="8" valign="top" style="padding:20px 5px;">
  ...
  <tr>
   ...
   <td colspan="10" valign="top" style="line-height:20px; padding:0;"> 
		<table width="100%"  border="0" cellspacing="0" style="border-color:#666" >
				  ...
				  <tr style="" class="name">
						...
						<td  style="border-right:none;" align="center">Name:<hr></td>
		
				  </tr> 
				  <tr style="" class="sign">
						<td  align="center">Sign:<hr></td>
						<td  style="border-right:none;" align="center">Sign:<hr></td>
   ...
   <td colspan="10" valign="top" style="line-height:20px; padding:0;"> 
		<table width="100%"  border="0" cellspacing="0" style="border-color:#666" >
				  ...
				  <tr class="payment_head">
						<td width="50%" align="center"> Payment Date</td>
						<td width="50%" align="center" style="border-right:none"> Payment Voucher No </td>
				  ...
				  <tr class="payment_head1 payment_dtl">
						...
						<td   align="center" style="border-right:none;"> &nbsp </td>
				  </tr> 
