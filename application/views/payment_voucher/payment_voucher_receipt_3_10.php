...
<div>
 ...
 <tr>
    ...
    <tr style="border-top: 1px solid #666;">
      ...
      <td colspan="4" valign="top" style="padding:20px 5px;">
                <p style="margin:0;text-align:left;line:height:22px;font-weight:bold; ">Journal Voucher No:-</p> 
				<br>
            
      </td> 
		<td colspan="3" valign="top" style="padding:20px 5px;">
               <p style="margin:0;text-align:left;line:height:22px;font-weight:bold; ">Payment Date:-</p> 
            
		</td>  	
		<td colspan="3" valign="top" style="padding:20px 5px;">
              <p style="margin:0;text-align:left;line:height:22px;font-weight:bold; ">Payment Voucher No:-</p> 
  ...
  <tr>
   ...
   <td colspan="10" valign="top" style="line-height:20px; padding:0;"> 
		<table width="100%"  border="0" cellspacing="0" style="border-color:#666" >
				  ...
				  <tr class="payment_head1 payment_dtl">
				  ...
				  <tr  style="background:#ececec " class="heading payment_head1 ">
						...
						<td   align="center" style="border-right:none"> Checked By</td>
				  </tr> 
					
					
				  <tr style="" class="name1">
				 
						<td  align="center">Name:&nbsp;&nbsp;<?=$data[0]->user_name?> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<span class="sign_1">Sign: _______________________________</span> </td>
					
						
						<td  style="border-right:none;" align="center"> <span class="name_1">Name:_______________________________</span>&nbsp;&nbsp; <span class="sign_2">Sign:_______________________________</span></td>
   ...
   <td colspan="10" valign="top" style="line-height:20px; padding:0;"> 
		<table width="100%"  border="0" cellspacing="0" style="border-color:#666" >
				  ...
				  <tr  style="background:#ececec " class="heading payment_head1 ">
						<td   align="center" width="459px"> Verified By </td>
				   ...
				   <tr style="" class="name1">
						...
						<td  align="center">Name:_______________________________ &nbsp;&nbsp;  <span class="sign_1">Sign: _______________________________</span> </td>
