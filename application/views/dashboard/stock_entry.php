                ...
                <!-- PAGE CONTENT WRAPPER -->
                 <div class="page-content-wrap">
                    <div class="row main-wrapper">
                        ...
                        <form id="form_sales_rep_location_details" role="form"   class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php if (isset($data)) echo base_url(). 'index.php/Sales_rep_store_plan/save/'; else echo base_url().'index.php/Sales_rep_store_plan/save'; ?>" >
                           ...
                           <div class="" id="stock_entry"  >
                              ...
                              <div class="row">
								...
								<div class="panel-footer">
									<a href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/clear_session" class="btn btn-danger"  type="reset" id="reset">Cancel</a>
