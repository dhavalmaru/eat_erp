              ...
              <div class="row">
				...
				<div class="row">
                    ...
                    <form id="form_sales_rep_distributor_details" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php if (isset($data)) echo base_url(). 'index.php/sales_rep_distributor/save/' . $data[0]->id; else echo base_url().'index.php/sales_rep_distributor/save'; ?>">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/sales_rep_distributor" class="button shadow btn_color" type="reset" id="reset">Cancel</a>
                            <a href="#" id="btn_save" class="right button shadow btn_color" style="<?php if(isset($data[0]->id)) {if($access[0]->r_edit=='0') echo 'display: none;'; else if(substr($data[0]->id,0,1)=="d") echo 'display: none;';} else if($access[0]->r_insert=='0' && $access[0]->r_edit=='0') echo 'display: none;'; ?>">Save</a>
