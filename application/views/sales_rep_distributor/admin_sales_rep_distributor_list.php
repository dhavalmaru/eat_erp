								...
								<table id="customers2" class="table datatable table-bordered"  >
									...
									<tbody>
										...
										<tr id="trow_<?php echo $i;?>">
											...
											<td style="text-align:center; vertical-align: middle; "><a href="<?php echo base_url() . 'index.php/sales_rep_distributor/edit/'.$data[$i]->id; ?>"><i class="fa fa-edit"></i></a></td>
											
											<td>
													<?php echo $data[$i]->distributor_name; ?>
