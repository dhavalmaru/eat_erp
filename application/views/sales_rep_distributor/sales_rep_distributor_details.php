                           ...
                           ?>
							...
							<div class="col s12">
								...
								<div class="input-field col s12 ">
									...
									<input type="text" class="form-control" name="margin" placeholder="Margin" value="<?php if(isset($margin)) echo $margin;?>"/>
							...
							<div class="row ">
								...
								<div class="col s12">
									<div class="input-field col s12">
									  ...
									  <textarea name="remarks" class="materialize-textarea"  ><?php if(isset($remarks)) echo $remarks;?></textarea>
									</div>
								</div>
							</div>
                            </div>                          
