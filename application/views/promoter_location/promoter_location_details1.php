        ...
        <div class="page-content-wrap">
            <div class="row main-wrapper">
                <div class="main-container">           
                    ...
                    <form id="form_sales_rep_location_details" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php if (isset($data)) echo base_url(). 'index.php/promoter_location/save/' . $data[0]->id; else echo base_url().'index.php/promoter_location/save'; ?>">
                        ...
                        <div class="col-md-12 custom-padding" style="padding:0;" >
                            ...
                            <div class="panel-body">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <select name="distributor_id" id="distributor_id" class="form-control" style="<?php if(isset($data)) {if($data[0]->distributor_type=='Old') echo ''; else  echo 'display: none;';} ?>">
                                                ...
                                                <?php if(isset($distributor)) { for ($k=0; $k < count($distributor) ; $k++) { ?>
                                                        <option value="<?php echo $distributor[$k]->id; ?>"><?php echo $distributor[$k]->store_name; ?></option>
                                                <?php }} ?>
                                            </select>
                                ...
                                <div class="ava_qty" style="display:none;">

                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label class="col-md-2 col-sm-2 col-xs-12 control-label">EAT Anytime Orange Bar </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="number" value="<?php if(isset($data1)) echo $data1[0]->orange_bar;?>" class="form-control" name="orange_bar" placeholder="Available Stock"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="number" value="<?php if(isset($data1)) echo $data1[0]->mint_bar;?>" class="form-control" name="mint_bar" placeholder="Available Stock"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="number" value="<?php if(isset($data1)) echo $data1[0]->butterscotch_bar;?>" class="form-control" name="butterscotch_bar" placeholder="Available Stock"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="number" value="<?php if(isset($data1)) echo $data1[0]->chocopeanut_bar;?>" class="form-control" name="chocopeanut_bar" placeholder="Available Stock"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="number" value="<?php if(isset($data1)) echo $data1[0]->bambaiyachaat_bar;?>" class="form-control" name="bambaiyachaat_bar" placeholder="Available Stock"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="number" value="<?php if(isset($data1)) echo $data1[0]->mangoginger_bar;?>" class="form-control" name="mangoginger_bar" placeholder="Available Stock"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
