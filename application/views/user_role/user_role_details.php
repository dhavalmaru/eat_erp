     																...
     																<tbody>
     																	...
     																	<tr id="trow_9">
     																		...
     																		<td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="8" <?php if(isset($editoptions[8])) { if($editoptions[8]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          ...
                                                                                          <tr id="trow_28">
                                                                                               <td>Bank Master</td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="8" <?php if(isset($editoptions[28])) { if($editoptions[28]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="8" <?php if(isset($editoptions[28])) { if($editoptions[28]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="8" <?php if(isset($editoptions[28])) { if($editoptions[28]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="8" <?php if(isset($editoptions[28])) { if($editoptions[28]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="8" <?php if(isset($editoptions[28])) { if($editoptions[28]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="8" <?php if(isset($editoptions[28])) { if($editoptions[28]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
                                                                                          <tr id="trow_29">
                                                                                               <td>Area</td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="8" <?php if(isset($editoptions[29])) { if($editoptions[29]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="8" <?php if(isset($editoptions[29])) { if($editoptions[29]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="8" <?php if(isset($editoptions[29])) { if($editoptions[29]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="8" <?php if(isset($editoptions[29])) { if($editoptions[29]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="8" <?php if(isset($editoptions[29])) { if($editoptions[29]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="8" <?php if(isset($editoptions[29])) { if($editoptions[29]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
                                                                                          <tr id="trow_30">
                                                                                               <td>Distributor Type</td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="8" <?php if(isset($editoptions[30])) { if($editoptions[30]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="8" <?php if(isset($editoptions[30])) { if($editoptions[30]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="8" <?php if(isset($editoptions[30])) { if($editoptions[30]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="8" <?php if(isset($editoptions[30])) { if($editoptions[30]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="8" <?php if(isset($editoptions[30])) { if($editoptions[30]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="8" <?php if(isset($editoptions[30])) { if($editoptions[30]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
                                                                                          <tr id="trow_31">
                                                                                               <td>Zone</td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="8" <?php if(isset($editoptions[31])) { if($editoptions[31]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="8" <?php if(isset($editoptions[31])) { if($editoptions[31]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="8" <?php if(isset($editoptions[31])) { if($editoptions[31]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="8" <?php if(isset($editoptions[31])) { if($editoptions[31]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="8" <?php if(isset($editoptions[31])) { if($editoptions[31]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="8" <?php if(isset($editoptions[31])) { if($editoptions[31]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
     																	<tr id="trow_10">
     																	...
     																	<tr id="trow_14">
     																		...
     																		<td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="13" <?php if(isset($editoptions[13])) { if($editoptions[13]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          ...
                                                                                          <tr id="trow_32">
                                                                                               ...
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="13" <?php if(isset($editoptions[32])) { if($editoptions[32]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="13" <?php if(isset($editoptions[32])) { if($editoptions[32]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="13" <?php if(isset($editoptions[32])) { if($editoptions[32]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="13" <?php if(isset($editoptions[32])) { if($editoptions[32]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="13" <?php if(isset($editoptions[32])) { if($editoptions[32]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="13" <?php if(isset($editoptions[32])) { if($editoptions[32]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
                                                                                          <tr id="trow_33">
                                                                                               <td>Credit Debit Note</td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="13" <?php if(isset($editoptions[33])) { if($editoptions[33]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="13" <?php if(isset($editoptions[33])) { if($editoptions[33]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="13" <?php if(isset($editoptions[33])) { if($editoptions[33]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="13" <?php if(isset($editoptions[33])) { if($editoptions[33]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="13" <?php if(isset($editoptions[33])) { if($editoptions[33]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="13" <?php if(isset($editoptions[33])) { if($editoptions[33]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
     																	<tr id="trow_15">
     																	...
     																	<tr id="trow_21">
     																		...
     																		<td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="20" <?php if(isset($editoptions[20])) { if($editoptions[20]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          ...
                                                                                          <tr id="trow_34">
                                                                                               ...
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="view[]" value="13" <?php if(isset($editoptions[34])) { if($editoptions[34]->r_view == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="insert[]" value="13" <?php if(isset($editoptions[34])) { if($editoptions[34]->r_insert == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="update[]" value="13" <?php if(isset($editoptions[34])) { if($editoptions[34]->r_edit == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="delete[]" value="13" <?php if(isset($editoptions[34])) { if($editoptions[34]->r_delete == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="approval[]" value="13" <?php if(isset($editoptions[34])) { if($editoptions[34]->r_approvals == 1) { echo 'checked';} } ?> /></td>
                                                                                               <td class="center"><input type="checkbox" class="cls_chk" name="export[]" value="13" <?php if(isset($editoptions[34])) { if($editoptions[34]->r_export == 1) { echo 'checked';} } ?> /></td>
                                                                                          </tr>
     																	<tr id="trow_24">
