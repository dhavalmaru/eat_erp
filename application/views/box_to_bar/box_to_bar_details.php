        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/box_to_bar'; ?>" >Box To Bar List </a>  &nbsp; &#10095; &nbsp; Box To Bar Details</div>
                      ...
                      <div class="row main-wrapper">
					    <div class="main-container">           
                         <div class="box-shadow">	
                            ...
                            <form id="form_box_to_bar_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/box_to_bar/update/' . $data[0]->id; else echo base_url().'index.php/box_to_bar/save'; ?>">
                               <div class="box-shadow-inside">
                                    ...
                                    <div class="table-stripped form-group" style="padding:15px;" >
                                        ...
                                        <?php $i=0; if(isset($box_to_bars)) {
                                            ...
                                            <tr id="box_<?php echo $i; ?>_row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control format_number qty" name="qty[]" id="qty_<?php echo $i; ?>" placeholder="Qty" value="<?php if (isset($box_to_bars)) { echo format_money($box_to_bars[$i]->qty,2); } ?>"/>
                                                </td>
                                                <td style="display:none;">
                                                    <input type="text" class="form-control format_number grams" name="grams[]" id="grams_<?php echo $i; ?>" placeholder="Grams" value="<?php if (isset($box_to_bars)) { echo format_money($box_to_bars[$i]->grams,2); } ?>" readonly />
                                                </td>
                                                <td style="display:none;">
                                                    <input type="text" class="form-control format_number rate" name="rate[]" id="rate_<?php echo $i; ?>" placeholder="Rate" value="<?php if (isset($box_to_bars)) { echo format_money($box_to_bars[$i]->rate,2); } ?>" readonly />
                                                </td>
                                                <td style="display:none;">
                                ...
                                <div class="panel-footer">
									<a href="<?php echo base_url(); ?>index.php/box_to_bar" class="btn btn-danger" type="reset" id="reset">Cancel</a>
                        ...
                        if(data.result==1){
                            ...
                            for(var i=0; i<data.product_id.length; i++){
                                var newRow = jQuery('<tr id="bar_'+counter+'_row">'+
                                            ...
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" class="form-control total_bar_qty" name="total_bar_qty[]" id="total_bar_qty_'+counter+'" placeholder="Available Bar Qty" value="'+data.qty[i]+'" readonly />'+
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" class="form-control used_bar_qty" name="used_bar_qty[]" id="used_bar_qty_'+counter+'" placeholder="Bar Qty" value="" readonly />'+
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" class="form-control bal_bar_qty" name="bal_bar_qty[]" id="bal_bar_qty_'+counter+'" placeholder="Total Bar Qty" value="" readonly />'+
                                            '</td>'+
                                        '</tr>');
            ...
            function get_bal_bar_details(){
                        ...
                        success: function(data){
                            if(data.result==1){
                                for(var i=0; i<data.product.length; i++){
                                    ...
                                    var product_name=data.product_name[i];
                                    ...
                                    if(flag==false){
                                        ...
                                        tot_product_name[k]=product_name;
                ...
                for(var j=0; j<tot_product_id.length; j++){
                    ...
                    if(flag==false){
                        ...
                        var newRow = jQuery('<tr id="bar_'+counter+'_row">'+
                                            '<td>'+
                                                '<input type="hidden" class="form-control bar_id" name="bar_id[]" id="bar_id_'+counter+'" placeholder="Bar Id" value="'+tot_product_id[j]+'" readonly />'+
                                                '<input type="text" class="form-control bar_name" name="bar_name[]" id="bar_name_'+counter+'" placeholder="Bar Name" value="'+tot_product_name[j]+'" readonly />'+
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" class="form-control total_bar_qty" name="total_bar_qty[]" id="total_bar_qty_'+counter+'" placeholder="Available Bar Qty" value="0" readonly />'+
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" class="form-control used_bar_qty" name="used_bar_qty[]" id="used_bar_qty_'+counter+'" placeholder="Bar Qty" value="'+tot_qty[j]+'" readonly />'+
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" class="form-control bal_bar_qty" name="bal_bar_qty[]" id="bal_bar_qty_'+counter+'" placeholder="Total Bar Qty" value="'+tot_qty[j]+'" readonly />'+
                                            '</td>'+
                                        '</tr>');
                        $('#bar_details').append(newRow);
                        counter++;
