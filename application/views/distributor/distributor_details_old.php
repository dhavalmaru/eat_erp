                                    ...
                                    <div class="table-stripped form-group" style="padding:15px;" >
                                        ...
                                        <?php $i=0; if(isset($distributor_consignee)) {
                                            ...
                                            <tr id="consignee_<?php echo $i; ?>_row">
                                                ...
                                                <td>
                                                    <input type="hidden" name="con_city_id[]" id="con_city_id_<?php echo $i; ?>" />
                                                ...
                                                <td>
                                                    <input type="hidden" name="con_state_id[]" id="con_state_id_<?php echo $i; ?>" />
                                                ...
                                                <td>
                                                    <input type="hidden" name="con_country_id[]" id="con_country_id_<?php echo $i; ?>" />
            ...
            jQuery(function(){
                ...
                $('#repeat-consignee').click(function(event){
                    ...
                    var newRow = jQuery('<tr id="consignee_'+counter2+'_row">' + 
                                                ...
                                                '</td>' + 
                                                '<td>' + 
                                                    '<input type="hidden" name="con_city_id[]" id="con_city_id_'+counter2+'" />' + 
                                                ...
                                                '</td>' + 
                                                '<td>' + 
                                                    '<input type="hidden" name="con_state_id[]" id="con_state_id_'+counter2+'" />' + 
                                                ...
                                                '</td>' + 
                                                '<td>' + 
                                                    '<input type="hidden" name="con_country_id[]" id="con_country_id_'+counter2+'" />' + 
                    ...
                    // $('.autocompleteCity').autocomplete({source:fakedata});
