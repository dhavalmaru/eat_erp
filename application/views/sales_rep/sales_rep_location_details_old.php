                           ...
                           <div class="row"  >
                              <div class="col s12">
                                 ...
                                 <div class="input-field col s9"   style="top:0.8rem;color:#000!important;">
                                    ...
                                    <input type="hidden"  name="sales_rep_loc_id" id="sales_rep_loc_id" value="<?php if(isset($stock_detail['sales_rep_loc_id'])) echo $stock_detail['sales_rep_loc_id'];?>"/>
                                    ...
                                    <input type="hidden"  name="merchandiser_stock_id" id="merchandiser_stock_id" value="<?php if(isset($stock_detail['visit_id'])) echo $stock_detail['visit_id'];?>"/>

                                    <input type="hidden"  name="follow_type" id="follow_type" value="<?php if(isset($data[0]->follow_type)) echo $data[0]->follow_type;?>"/>
                           ...
                           <div class="row" id="channel_type_div">
                              <div class="col s12">
                                 ...
                                 <div class="input-field col s9">
                                    <select class="browser-default" name="channel_type" id="channel_type" onchange="getselectdiv(this)" onclick="getselectdiv(this)">
                                       <?php 
                                       ...
                                       <option value="Old" 
                                          <?php 
                                             if(isset($data[0]->distributor_type))
                                                   ...
                                                   if(isset($data[0]->distributor_type)) {if ($data[0]->distributor_type=='Old') echo 'selected';}
                                                    if($visit_detail!='')
                                                    {
                                                      if ($visit_detail['distributor_types']=='Old') echo 'selected';
                                                    }
                                                   ?>>Old</option>
                                       <option value="New" <?php if(isset($data)) {if ($data[0]->distributor_type=='New') echo 'selected';}
                                          if($visit_detail!='')
                                          {
                                             if ($visit_detail['distributor_types']=='Old') echo 'selected';
                                          }
                           ...
                           <div class="relation_store" style="display:none">
                              <div class="row " >
                                 <div class="col s12">
                                    ...
                                    <div class="input-field col s9">
                                       <select name="reation_id" id="reation_id" class="browser-default" onchange="get_mt_location();">
                                          <option value="">Select</option>
                                       </select>
                                    </div>
                                 </div>
