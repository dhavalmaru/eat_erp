                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control datepicker" name="from_date" id="from_date" value="<?php if(isset($date)) echo (($date!=null && $date!='')?date('d/m/Y',strtotime($date)):date('d/m/Y')); else echo date('d/m/Y'); ?>">
                                            </div>
                                            <label class="col-md-2 col-sm-2 col-xs-12 control-label">To <span class="asterisk_sign">*</span></label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control datepicker" name="to_date" id="to_date" value="<?php if(isset($date)) echo (($date!=null && $date!='')?date('d/m/Y',strtotime($date)):date('d/m/Y')); else echo date('d/m/Y'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <select name="sales_rep_id" id="sales_rep_id" class="form-control">
                                                    ...
                                                    <?php if(isset($sales_rep)) { for ($k=0; $k < count($sales_rep) ; $k++) { ?>
                                                            <option value="<?php echo $sales_rep[$k]->id; ?>" <?php if(isset($sales_rep_id)) { if($sales_rep[$k]->id==$sales_rep_id) { echo 'selected'; } } ?>><?php echo $sales_rep[$k]->sales_rep_name; ?></option>
                                                    <?php }} ?>
                                                </select>
                                            </div>
