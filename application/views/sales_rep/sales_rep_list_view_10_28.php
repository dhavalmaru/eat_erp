		...
		<div class="navbar">
		 ...
		 <ul class="tabs">
					  		<?php $explode =  explode(" ",$checkstatus);
					  		 ...
					  		 ?>
							<li class="tab"><a class="<?php if($checkstatus=='Monday') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/checkstatus/Monday" target="_self">Mon</a></li>

							<li class="tab"><a class="<?php if($checkstatus=='Tuesday') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/checkstatus/Tuesday" target="_self">Tues</a></li>
							
							<li class="tab"><a class="<?php if($checkstatus=='Wednesday') echo 'active'; ?>"href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/checkstatus/Wednesday" target="_self">Wed</a></li>
							
							<li class="tab"><a class="<?php if($checkstatus=='Thursday') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/checkstatus/Thursday" target="_self">Thur</a></li>
							
							<li class="tab"><a class="<?php if($checkstatus=='Friday') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/checkstatus/Friday" target="_self">Fri</a></li>
							
							<li class="tab"><a class="<?php if($checkstatus=='Saturday') echo 'active'; ?>"  href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan/checkstatus/Saturday" target="_self">Sat</a></li>
						  </ul>
		</div>
								...
								<div class="col s12">
										<div class="wishlist-title s-title beat_plan">
											<div class="row">
												...
												<div class="col s2">
													<a href="<?php echo base_url().'index.php/Sales_rep_store_plan/locations/'.$data[$i]->store_id; ?> "class=""><i class="fa fa-map-marker"></i></a>
												</div>
												<div class="col s5">
												...
												if($date==null){?>
												<a href="<?php echo base_url().'index.php/Sales_rep_store_plan/add/'.$data[$i]->bit_plan_id.'/'.$checkstatus;?>"class="button shadow orange  lighten-1">Check In</a>
												...
												<?php 
												  ...
												  { ?>
												  	<a href="<?php echo base_url().'index.php/Sales_rep_store_plan/edit/'.$data[$i]->bit_plan_id;?>"class="button shadow orange  lighten-1">Edit</a>
												  <?php }
												  else 
												  {?>
												  		<a href="<?php echo base_url().'index.php/sales_rep_location/edit/'.$data[$i]->mid;?>"class="button shadow orange  lighten-1">Edit</a>
												 <?php }
												?>
