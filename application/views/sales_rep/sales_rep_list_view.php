               ...
               <div class="col s12">
                  <div class="wishlist-title s-title beat_plan">
                     <div class="row">
                        ...
                        <?php } 
						else if($temp_date > $FirstDay && $temp_date < $now) { ?>
						 ...
						 <div class="col s4">
                           ...
                           <a class="button shadow orange  lighten-1">
                           <?= ($gt_followup[$i]->is_visited!=NULL?'Visited':'Not Visited') ?>
                           </a>
                        </div>
						<?php
						}?>
                        ...
                        <?php }  
						 ...
						 <div class="col s4">
                           <?php 
							 $date= $data[$i]->date_of_visit;
                              if($date==null){
                              	$url =  base_url().'index.php/Sales_rep_store_plan/add/'.$data[$i]->bit_id.'/'.$checkstatus.'/GT';
                              ?>
                           <a class="button shadow orange  lighten-1">Not Visited</a>
                           <?php
                              }
                           ...
                           <?php 
                              if($data[$i]->bit_plan_id!=0)
                              { ?>
                           <a  class="button shadow orange  lighten-1">Visited</a>
                           <?php }
                              else 
                              {?>
                           <a  class="button shadow orange  lighten-1">Visited</a>
                     ...
                     <div class="row">
						...
						<div class="col s4">
                           <?php 
                              ...
                              ?>
                           <a  class="button shadow orange  lighten-1"><?= ($mt_followup[$i]->is_visited!=NULL?'Visited':'Not Visited') ?></a>
                        </div>
