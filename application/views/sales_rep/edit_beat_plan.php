				   ...
				   <div class="row" >
				   	 <div class="page-width">	
                           ...
                           <div class="input-field col s3">
							<label>Sales Representative Name<span class="asterisk_sign">*</span></label>
							</div> 
					...
					<form id="form_sales_rep_location_details" role="form" class="" method="post" enctype="multipart/form-data" action="<?php echo base_url().'index.php/Sales_rep/save_changesequence'; ?>">					  
