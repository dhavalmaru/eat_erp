                    ...
                    <form id="form_sales_rep_location_details" role="form"  method="post" enctype="multipart/form-data" action="<?php if (isset($data)) echo base_url(). 'index.php/Sales_rep_store_plan/save/'.$id; else echo base_url().'index.php/Sales_rep_store_plan/save'; ?>" onsubmit="return myFunction()" >
								...
								<div class="row old_dist_details">
                              	...
                              	<div class="row">
									<div class="col s12">
										<div class="input-field col s12">
										  <textarea name="remarks" class="materialize-textarea" ><?php if(isset($data[0]->remarks)) echo $data[0]->remarks;?></textarea>
						...
						<hr>	
							...
							<a href="<?php echo base_url(); ?>index.php/Sales_rep_store_plan" class="button shadow btn_color " type="reset" id="reset" style="    float: left;padding: 4px 12px;">Cancel</a>
							...
							<input type="button" id="pl_ord" value="Place Order" name="srld" class="right button shadow btn_color " style="<?php if(isset($data[0]->id)) {if($access[0]->r_edit=='0') echo 'display: none;';} else if($access[0]->r_insert=='0' && $access[0]->r_edit=='0') echo 'display: none;'; ?>margin-right: 2px;" />
                            </div>
