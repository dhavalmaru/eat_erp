                                    ...
                                    <div class="col s12">
                                       <div class="input-field col s3">
											...
											<div class="input-field col s9"   style="top:0.8rem;color:#000!important;">
												...
												<input type="hidden"  name="date_of_visit" id="date_of_visit" value="  <?php if(isset($data)) echo (($data[0]->date_of_visit!=null && $data[0]->date_of_visit!='')?date('d/m/Y',strtotime($data[0]->date_of_visit)):date('d/m/Y')); else echo date('d/m/Y'); ?>"/>
