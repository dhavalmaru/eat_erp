...
function initMap() {
	...
	var address;
	$.ajax({
		url: "<?php echo base_url() . 'index.php/Sales_rep_store_plan/get_lat_long' ?>",
	   ...
	   navigator.geolocation.getCurrentPosition(function(position) {
            s= parseFloat( position.coords.latitude);
			e=parseFloat(position.coords.longitude);
			start = new google.maps.LatLng(s, e);
