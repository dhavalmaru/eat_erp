											...
											<tbody>
												...
												<tr>
													...
													<td>
		                                                ...
		                                                <a href="<?php echo base_url().'index.php/sales_rep_location/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_visit!=null && $data[$i]->date_of_visit!='')?date('d/m/Y',strtotime($data[$i]->date_of_visit)):''); ?></a>
		                                            </td>
