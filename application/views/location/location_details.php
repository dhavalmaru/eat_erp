                    ...
                    <div class="row main-wrapper">
					    <div class="main-container">           
                         <div class="box-shadow">
                            <form id="form_location_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/location/update/' . $data[0]->id; else echo base_url().'index.php/location/save'; ?>">
