      ...
      <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
        <div class="heading-h3">
          <div class="heading-h3-heading mobile-head">
            <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Sales Upload
          </div>
				  <div class="heading-h3-heading mobile-head">
        ...
        <div class="modal fade" id="myModal" role="dialog" style="">
          <div class="modal-dialog">
            <div class="modal-content" style="">
              ...
              <form method="POST" action="<?php echo base_url();?>index.php/Sales_upload/upload_file" class="form-horizontal excelform" enctype="multipart/form-data">
                        ...
                        <tbody>
                          <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url().'assets/uploads/sales_upload/'.$data[$i]->file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                              </td>
                              <td>
                                <?php if($data[$i]->error_file_name!=null && $data[$i]->error_file_name!=''){ ?>
                                <a href="<?php echo base_url().'assets/uploads/sales_upload/'.$data[$i]->error_file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                                <?php } ?>
                              </td>
                              <td>
                                ...
                                <a href="<?php echo base_url().'assets/uploads/sales_upload/'.$data[$i]->check_file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                                <?php } ?>
                              </td>
