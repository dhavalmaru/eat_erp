         ...
         <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
				   ...
				   <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/Asin_master'; ?>" > ASIN List </a>  &nbsp; &#10095; &nbsp; ASIN Details</div>
                   ...
                   <div class="page-content-wrap">
					...
					<div class="main-container">           
                         <div class="box-shadow"> 
                            ...
                            <form id="form_asin_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/Asin_master/update/' . $data[0]->id; else echo base_url().'index.php/asin_master/save'; ?>">	
							<div class="box-shadow-inside">
                                ...
                                <div class="panel-footer">
									<a href="<?php echo base_url(); ?>index.php/Asin_master" class="btn btn-danger" type="reset" id="reset">Cancel</a>
