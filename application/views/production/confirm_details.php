        ...
        <div class="page-container page-navigation-top">            
            ...
            <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <div class="page-content-wrap">
                    ...
                    <form id="form_confirm_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/production/confirm/' . $data[0]->id; ?>">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control" name="from_date" id="from_date" placeholder="From Date" value="<?php if(isset($data)) echo (($data[0]->from_date!=null && $data[0]->from_date!='')?date('d/m/Y',strtotime($data[0]->from_date)):'');?>" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control" name="to_date" id ="to_date" placeholder="To Date" value="<?php if(isset($data)) echo (($data[0]->to_date!=null && $data[0]->to_date!='')?date('d/m/Y',strtotime($data[0]->to_date)):''); ?>" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control datepicker" name="confirm_to_date" id ="confirm_to_date" placeholder="Confirm To Date" value="<?php if(isset($data)) echo (($data[0]->confirm_to_date!=null && $data[0]->confirm_to_date!='')?date('d/m/Y',strtotime($data[0]->confirm_to_date)):''); ?>" />
                                        </div>
                                    </div>
                                </div>
