...
<body style="margin: 1px;">
    <div class="spacing" style="width:512px;  float:left; margin-right:20px;">
        <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:512px; margin:auto; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:8px; font-weight:400; border:1px solid #666;">
            ...
            <tr>
                ...
                <td valign="top" style="border:0!important; font-size:8px; font-weight:500; text-align:right;"><?php if (isset($invoice_details[$inv_cnt]['cst'])) echo strval($invoice_details[$inv_cnt]['cst']) . '%'; ?></td>
                <td style=" font-size:8px; font-weight:500;"  >  
                    <span style="text-align:left; float:left"> &#8377; </span> 
                    <span style="text-align:right; float:right"><?php if (isset($invoice_details[$inv_cnt]['cst_amount'])) echo $invoice_details[$inv_cnt]['cst_amount']; ?></span> 
                </td>
            </tr>
            <tr>
                ...
                <td  style=" font-size:8px; font-weight:500;" >  
                    <span style="text-align:left; float:left"> &#8377; </span> 
                    <span style="text-align:right; float:right"><?php if (isset($invoice_details[$inv_cnt]['total_amount_with_tax'])) echo $invoice_details[$inv_cnt]['total_amount_with_tax']; ?></span> 
                </td>
            </tr>
            <tr>
    ...
    <div class="spacing" style="width:512px;  float:left;">
        <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:512px; margin:auto; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:8px; font-weight:400; border:1px solid #666;">
            <tr>
                <td colspan="6" align="left" valign="top" style="padding:0;">
                    <table width="100%" border="0">
    ...
    <!-- <div>&nbsp;</div><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/> -->

    <?php 
        $cnt = count($invoice_details[$inv_cnt]['description']);
        if($cnt==1) {
            echo '<div style="margin-bottom: 130px; display: block;">&nbsp;</div>';
        } else if($cnt==2) {
            echo '<div>&nbsp;</div><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/>';
        } else if($cnt==3) {
            echo '<div>&nbsp;</div><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/>';
        } else if($cnt==4) {
            echo '<div>&nbsp;</div><br clear="all"/><br clear="all"/><br clear="all"/><br clear="all"/>';
        } else if($cnt==5) {
...
<body>
    ...
    <?php 
        // if($vou_cnt!=(count($voucher_details)-1) || count($sku_details)>0){
            $cnt = count($voucher_details[$vou_cnt]['description']);
            if($cnt==1) {
...
<head>
    ...
    <style>
        ...
        table {border-collapse:collapse; border-color:#333; margin-bottom:20px;}
        table th {font-size:15px; background:#f1f1f1; padding:8px 5px;}
        h1 {padding:3px; margin:0; font-size:20px; padding:10px; background:#f1f1f1; margin-bottom:5px}
        h2 {padding:3px; margin:0; font-size:16px; padding:8px 0; text-align:center;}
    </style>
</head>
<body>
        ...
        <div style="width:400px;  ">
            <table cellspacing="0" cellpadding="5" border="1"> 
                <tr>
                    ...
                    <td width="189" colspan="5"><div align="right">Andheri HO</div></td>
                </tr>
                <tr>
                    <td>Date</td>
...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Pending Payment Ledger</title>
    <style>
        body {    font-family: verdana; font-size:13px; padding:0; }
        table{ border-collapse:collapse; border-color:#333; margin-bottom:20px; }
