...
<div>
    <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:925px; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:12px; font-weight:400; border:1px solid #666; "    >
        ...
        <tr valign="top" style="border: none;">
            ...
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money( $distributor_in_items[$i]->amount,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_in_items[$i]->cgst_amt,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_in_items[$i]->sgst_amt,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_in_items[$i]->igst_amt,2); ?></p></td>
            ...
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_in_items[$i]->total_amt,2); ?></p></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="6" valign="middle" align="right" style="font-size:12px; font-weight:500;"><p style="margin:0;"><span style=" font-size:13px; font-weight:500;" >Total</span></p></td>
		              ...
		              <td  style=" font-size:12px; font-weight:500;" >  <span style="text-align:left; float:left"> &#8377; </span> <span style="text-align:right; float:right"><?php if (isset($data[0]->final_amount)) echo format_money($data[0]->final_amount,2); ?></span> </td>
		</tr>
        <tr>
   ...
   <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:925px; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:12px; font-weight:400; border:1px solid #666; "    >
       ...
       <?php  if(isset($distributor_exchange_items)) {for($i=0; $i<count($distributor_exchange_items); $i++){ ?>
        <tr valign="top" style="border: none;">
            ...
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money( $distributor_exchange_items[$i]->amount,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_exchange_items[$i]->cgst_amount,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_exchange_items[$i]->sgst_amount,2); ?></p></td>
            <td valign="top" align="right" style="border-left:1px solid #666; border-right:1px solid #666; border-top: none; border-bottom:none;"><p style="margin:0; "><?php echo format_money($distributor_exchange_items[$i]->igst_amount,2); ?></p></td>
...
<?php } ?>
	...
	<table class="user_data" border="0" width="925px" style="border-collapse:collapse;margin-top:15px;font-size:12px " class="table" cellspacing="10">
					<tr valign="center" >
						...
						if(date("d-m-Y h:m:i", strtotime($data[0]->created_on)) <> date("d-m-Y h:m:i", strtotime($data[0]->modified_on)))
