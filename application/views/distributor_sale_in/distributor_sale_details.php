...
<html lang="en">
    ...
    <body>								
        ...
        <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
            <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/distributor_sale_in'; ?>" >Super Stockist Sales Return List </a>  &nbsp; &#10095; &nbsp; Super Stockist Sales Return Details</div>
                ...
                <div class="row main-wrapper">
				    <div class="main-container">           
                     <div class="box-shadow">		
                        <form id="form_distributor_sale_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/distributor_sale_in/update/' . $data[0]->id; else echo base_url().'index.php/distributor_sale_in/save'; ?>">
                         <div class="box-shadow-inside">
                           <div class="col-md-12 custom-padding" style="padding:0;" >
                                            ...
                                            <select name="distributor_id" id="distributor_id" class="form-control">
                                                <option value="">Select</option>
												 <?php //if(isset($store)) { for ($k=0; $k < count($store) ; $k++) { ?>
                                                        <option value="<?php// echo $store[$k]->id; ?>" <?php// if(isset($data)) { if($store[$k]->id==$data[0]->distributor_id) { echo 'selected'; } } ?>><?php //echo $store[$k]->store_name; ?></option>
                                                <?php //}} ?>
                            ...
                            <div class="panel-footer">
								<a href="<?php echo base_url(); ?>index.php/distributor_sale_in" class="btn btn-danger" type="reset" id="reset">Cancel</a>
    ...
    $('#zone_id').change(function(){
     var zone_id = $('#zone_id').val();
      ...
      // AJAX request
      $.ajax({
        url:'<?=base_url()?>index.php/Distributor_sale_in/get_store',
        method: 'post',
	 ...
	 $('#store_id').change(function(){
      ...
      // AJAX request
      $.ajax({
        url:'<?=base_url()?>index.php/Distributor_sale_in/get_location_data',
        method: 'post',
