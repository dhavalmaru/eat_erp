...
<body class="home">								
	...
	<div class="navbar">
		...
		<ul id="tabs-swipe-demo" class="tabs">
			<li class="tab col s3"><a id="tab1" class="active" href="#swipe-1" ><i class="material-icons">home</i></a></li>
		  <li class="tab col s3"><a id="tab2" href="#swipe-2"><i class="material-icons">place</i></a></li>
		  <li class="tab col s3"><a id="tab3" href="#swipe-3"><i class="material-icons">group</i></a></li>
		  <li class="tab col s3"><a id="tab4" href="#swipe-4"><i class="material-icons">shopping_cart</i></a></li>
...
<div id="swipe-2" class="col s12">
			...
			<div class="app-title">
				...
				<div class="wishlist-title s-title">
					...
					<div class="row">
						...
						<div class="col s5">
							<h6><?php echo $data3[$i]->distributor_status; ?></h6>
						</div>
					</div>
	...
	<div class="fixed-action-btn click-to-toggle" id=""style="top: 100px; right: 24px;">
			  <a class="btn-floating  pink waves-effect waves-light" id="add_float" href="<?php echo base_url() . 'index.php/sales_rep_location/add'; ?>">
...
Order List
		...
		<div class="fixed-action-btn click-to-toggle" id=""style="top: 100px; right: 24px;">
			  <a class="btn-floating  pink waves-effect waves-light" id="add_float" href="<?php echo base_url() . 'index.php/sales_rep_distributor/add'; ?>">
				<i class="large material-icons">add</i>
			  </a>
...
<div id="swipe-4" class="col s12 ">
	<div class="wishlist app-section">
		<div class="container">
			...
			<div class="fixed-action-btn click-to-toggle" id=""style="top: 100px; right: 24px;">
			  <a class="btn-floating  pink waves-effect waves-light" id="add_float" href="<?php echo base_url() . 'index.php/sales_rep_order/add'; ?>">
				<i class="large material-icons">add</i>
			  </a>
	...
	<script>
		...
		// $('#add_float').click(function(){
	
		// if($("#swipe-2").hasClass("active"))
		// {
			// $('#add_float1').show();
			// $('#add_float').attr('href', '<?=base_url()?>index.php/sales_rep_location/add');
		// }
		
		// if($("#swipe-3").hasClass("active"))
		// {
				// $('#add_float1').show();
			// $('#add_float').attr('href', '<?=base_url()?>index.php/sales_rep_distributor/add');
		// }
		
		// if($("#swipe-4").hasClass("active"))
		// {
				// $('#add_float1').show();
			// $('#add_float').attr('href', '<?=base_url()?>index.php/sales_rep_order/add');
		// }
		// });
