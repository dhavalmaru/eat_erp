...
<div id="swipe-4" class="col s12 ">
	<div class="wishlist app-section">
		<div class="container">
			...
			<div class="entry shadow">
			<div class="app-title">
				<h4> Todays Order List</h4>
				<a href="<?php echo base_url().'index.php/sales_rep_order';?>" class="right" style="margin-top: -16px;">View All</a>
			</div>
