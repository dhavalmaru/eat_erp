                                          ...
                                          <div class="">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col s12">
                                                   ...
                                                   <div class="input-field col s5">
                                                      <div class="">
                                                         <input type="radio" class="" name="bar_type1" value="Bar" id="box_bs" onclick="set_radio_button(1,this)" >
                                                         <label for="box_bs"  
                                                            <?php 
                                                               if(isset($ex1))
                                                               {
                                                               ...
                                                               ?>>Bar</label>
                                                         <input type="radio" class="" name="bar_type1" value="Box" id="box_bs1" onclick="set_radio_button(1,this)" checked="" 
                                                            <?php 
                                                               if(isset($ex1))
                                                               {
                                                                  if($ex1[1]=='Bar')
                                                ...
                                                <div class="col s12">
                                                   ...
                                                   <div class="input-field col s3">
                                                      <input type="number" value="<?php if(isset($order_detail['variety_box'])) echo $order_detail['variety_box'];?>" class="form-control qty" name="variety_box" placeholder="0"
                                                         id="type_8"/>
                                                   </div>
                                                                              <div class="input-field col s5">
                                                      <div class="">
