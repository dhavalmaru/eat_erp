    	...
    	<div class="page-container page-navigation-top">            
    		...
    		<div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
    			...
    			<div class="heading-h3"> 
    				<div class="heading-h3-heading">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Account Group List  </div>	 
    				...
    				<div class="u-borderBottom u-bgColorBreadcrumb ng-scope">
    					<div class="container u-posRelative u-textRight">
    						<div class="pull-left   btn-top" style="<?php //if($access[0]->r_insert=='0') echo 'display: none;';?>">
    							<a class="btn btn-success btn-block btn-padding" href="<?php echo base_url(); ?>index.php/AccountGroup/add">
    						...
    						<ul class="m-nav--linetriangle" ng-swipe-left="app.onInnerSwipe($event);" ng-swipe-right="app.onInnerSwipe($event);">
    							<li class="all">
    								<a  href="<?php echo base_url(); ?>index.php/AccountGroup/checkstatus">
    							...
    							<li class="approved" >
    								<a  href="<?php echo base_url(); ?>index.php/AccountGroup/checkstatus/Approved">
    							...
    							<li class="inactive">
    								<a  href="<?php echo base_url(); ?>index.php/AccountGroup/checkstatus/InActive">
    							...
    							<li class="pending">
    								<a  href="<?php echo base_url(); ?>index.php/AccountGroup/checkstatus/Pending">
    										...
    										<table id="customers2" class="table datatable table-bordered" >
    											...
    											<tbody>
    												...
    												<tr>
    													...
    													<td><a href="<?php echo base_url().'index.php/AccountGroup/edit/'.$data[$i]->id; ?>"><?php echo $data[$i]->group_name; ?></a></td>
    													<td><?php echo $data[$i]->gname; ?></td>
                                                        <td><?php echo $data[$i]->created_by; ?></td>
