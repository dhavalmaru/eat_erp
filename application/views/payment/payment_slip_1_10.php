...
.user_data tr,.user_data td,.user_data table
		{
...
<table>
	...
	<tbody>
		...
		<tr><td colspan="10" style="font-weight:bold; text-align:center;">Denomination</td></tr>
		<tr>
			<td style="font-weight:bold; text-align:center;">1000</td>
			<td style="font-weight:bold; text-align:center;">2000</td>
		...
		<tr>
			...
			<td style="text-align:center;"><?php if (isset($denomination['0']->denomination_2000)) {if ($denomination['0']->denomination_2000>0) echo $denomination['0']->denomination_2000;} ?></td>
...
<br>
 <table class="user_data" border="0" width="100%" style="border-collapse:collapse; margin: 0 auto; " class="table" cellspacing="0">
					<tr valign="bottom" >
						   <td style="font-weight:bold">Created By:</td>
						   <td><?php if(isset($createdby)) echo $createdby; ?></td>
						   <td style="font-weight:bold">Modified By:</td>
						   <td><?php if(isset($modifiedby)) echo $modifiedby; ?></td>
						   <td style="font-weight:bold">Approved By:</td>
						   <td><?php if(isset($approvedby)) echo $approvedby; ?></td>
					</tr>
					<tr valign="bottom" >
					     <td style="font-weight:bold">Created On:</td>
						    <td><?php if(isset($created_on)) echo date('d-F-Y',strtotime($created_on));?></td>
						   <td style="font-weight:bold">Modified On:</td>
						     <td><?php if(isset($modified_on)) echo date('d-F-Y',strtotime($modified_on)); ?></td>
						   <td style="font-weight:bold">Approved On:</td>
						     <td><?php if(isset($approved_on))echo date('d-F-Y',strtotime($approved_on)); ?>
	</div></td>
					</tr>
	</table>
</body>
