      ...
      <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
        <div class="heading-h3">
          <div class="heading-h3-heading mobile-head">
            <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Payment Upload
          </div>
				  <div class="heading-h3-heading mobile-head">
					  <div class="pull-right btn-margin">
              <?php $this->load->view('templates/download');?>
              <a class="btn btn-default-danger pull-right " style="margin:0px 8px!important;" href="<?php echo base_url().'index.php/Payment_upload/download_upload_format'; ?>" >
                        ...
                        <tbody>
                          <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url().'assets/uploads/payment_upload/'.$data[$i]->file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                              </td>
                              <td>
                                <?php if($data[$i]->error_file_name!=null && $data[$i]->error_file_name!=''){ ?>
                                <a href="<?php echo base_url().'assets/uploads/payment_upload/'.$data[$i]->error_file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                                <?php } ?>
                              </td>
                              <td>
                                ...
                                <a href="<?php echo base_url().'assets/uploads/payment_upload/'.$data[$i]->check_file_name;?>">
                                  <span class="fa fa-download" style="font-size:20px;"></span>
                                </a>
                                <?php } ?>
                              </td>
                              <td>
                                <?php if($data[$i]->status=='Uploading'){ ?>
                                  <a href="<?php echo base_url();?>index.php/Payment_upload/upload_file_data/<?php echo $data[$i]->id;?>">
                                    <button type="button" class="btn btn-default">Upload Data</button>
                                  </a>
                                <?php } else if($data[$i]->status=='Pending') { ?>
                                  <a href="<?php echo base_url();?>index.php/Payment_upload/approve_file_data/<?php echo $data[$i]->id;?>" style="margin-right: 5px;">
                                    <button type="button" class="btn btn-success">Approve File</button>
                                  </a>
                                  <a href="<?php echo base_url();?>index.php/Payment_upload/reject_file_data/<?php echo $data[$i]->id;?>">
