...
<div class="debit_note">
    ...
    <table width="100%" border="0" cellspacing="0" class="table" style="border-collapse:collapse;  ">
        ...
        <tr style="border:none;">
            ...
            <td width="40%" style="border:none;"><p><b> WHPL/RECEIPT/<?php echo calculateFiscalYearForDate($data['date_of_deposit'])?>/<?php if(isset($data['id'])) echo $data['id']; ?> </b></p></td>
            <td width="22%" style="border:none;"><p>Transaction Date</p></td>
            <td width="4%" style="border:none;">:</td>
            <td width="14%" style="border:none;">
                <p>
                    <b> 
                        <?php if (isset($data['date_of_deposit'])) echo date('d/m/Y',strtotime($data['date_of_deposit'])); ?>
        ...
        <!-- <tr style="border:none;">
		 ...
		 <tr style="border:none;">
            ...
            <td width="80%" style="border:none;" colspan="3">
                <p><b> <?php if (isset($data['b_name'])) echo $data['b_name']; ?> </b></p>
            </td>
        ...
        <tr valign="top"  style="border:none; ">
            ...
            <td colspan="<?=($items['0']->payment_mode=='Cheque'?'3':'2')?>" align="center" valign="top" style="border-right:none; "><p><b>Rs. <?php if (isset($data['total_amount'])) echo format_money($data['total_amount'],2); ?></b></p></td>
        </tr>
        ...
        <tr>
            <td height="40" colspan="<?=($items['0']->payment_mode=='Cheque'?'3':'3')?>" valign="top" style="border:none; border-bottom:1px solid #999; border-right:1px solid #999;"> 
                <p><b><?php if(isset($data['total_amount_in_words'])) echo $data['total_amount_in_words']; ?></b></p>
            </td>
    ...
    <table class="user_data" border="0" width="100%" style="border-collapse:collapse;margin-top:20px;font-size:12px " class="table" 	cellspacing="10">
				<tr valign="center" >
						 ...
						 <?php if(isset($data['createdby'])) echo $data['createdby']; ?>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
						  <span style="<?php if(isset($data['created_on'])) 
						if(date("d-m-Y h:m:i", strtotime($data['created_on'])) <> date("d-m-Y h:m:i", strtotime($data['modified_on'])))
						echo ' ';else echo 'display:none;';?>">
						 <b> Modified By:</b>
						  <?php if(isset($data['modifiedby'])) echo $data['modifiedby']; ?>  &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp </span>
						  <b> Approved By:</b>
						  <?php if(isset($data['approvedby'])) echo $data['approvedby']; ?></td>
						  
				</tr>
				<tr valign="center" >
					    <td width="100%" align="center"><b>Created On:</b>
						    <?php if(isset($data['created_on'])) echo date("d-m-Y h:m:i", strtotime($data['created_on']))?>&nbsp &nbsp &nbsp &nbsp
						<span style="<?php if(isset($data['created_on'])) 
						if(date("d-m-Y h:m:i", strtotime($data['created_on'])) <> date("d-m-Y h:m:i", strtotime($data['modified_on'])))
						echo ' ';else echo 'display:none;';?>">
						  <b> Modified On:</b>
						     <?php if(isset($data['modified_on'])) echo date("d-m-Y h:m:i", strtotime($data['modified_on'])) ?>&nbsp &nbsp &nbsp &nbsp </span>
						   <b> Approved On:</b>
						    <?php if(isset($data['approved_on']))echo date("d-m-Y h:m:i", strtotime($data['approved_on'])) ?>
							</td>
				</tr>
	</table>
</div>
