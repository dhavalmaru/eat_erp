...
<?php if(count($data)>0) {
	...
	?>
<div>
    <table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:1000px; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:12px; font-weight:400; border:1px solid #666; "    >
        <tr>
            <td colspan="5" align="left" valign="top" style="padding:0;">
            <table width="100%" border="0" cellspacing="0">
                <tr>
                    <td width="50%"><img src="<?php echo base_url().'/assets/invoice/'; ?>logo.png" alt="" width=" " height="50" /></td>
                    <td width="50%" style="color:#808080; text-align:center;">
            ...
            <td colspan="5" valign="top" style="line-height:20px; padding:0; border:0;"> 
                <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                    <tr style="border-bottom:1px solid #666;">
                        <td width="50%" rowspan="2" style="line-height:20px; padding-top: 0px; padding-bottom: 0px;border-bottom:1px solid #666;  ">
                            <p style="margin: 0px;">
                                <span style=" font-size:13px; font-weight:bold;" >Wholesome Habits Pvt Ltd</span>
                                <br /> C/109, Hind Saurashtra Ind. Estate. 85/86, </br> Andheri Kurla Road, Marol Naka, <br>Andheri East. Mumbai 400059 <br>+91 8268000456 <br>GSTIN: 27AABCW7811R1ZN <br>cs@eatanytime.in

                            </p> 
                        </td>
                        <td width="25%" valign="top" style="line-height:20px;  border-left:1px solid #666; padding-top: 0px; padding-bottom: 0px;">
                            <p style="margin: 0px;"> <span style=" font-size:12px; font-weight:bold;" >RIN no</span> <br /> 
                      <?php if(isset($data[0]->row_material_in_no)) echo $data[0]->row_material_in_no; ?>
                            </p>
                        </td>
						
						  
                     
						<td width="25%" valign="top" style="line-height:20px; padding-top: 0px; padding-bottom: 0px;">
                            <p style="margin: 0px;">  <span style=" font-size:12px; font-weight:bold;" >Dated 
							</span>  <br /><?php if(isset($data[0]->approved_on)) echo date('d-F-Y',strtotime($data[0]->approved_on)); ?>
                    ...
                    <tr style="border-bottom:0px solid #666;">
                        <td valign="top" style="line-height:20px; border-bottom:0px solid #666; border-bottom:1px solid #666;  border-left:1px solid #666; padding-top: 0px; padding-bottom: 0px;">
                            <p style="margin: 0px;"> <span style=" font-size:12px; font-weight:bold;" >PO No  </span> <br /> 
                           
                                                    <?php echo $data[0]->po_no?>
                            </p>
                        </td>
                        <td  valign="top" style="line-height:20px; padding-top: 0px; border-bottom:1px solid #666;  padding-bottom: 0px;">
                            <p style="margin: 0px;"> <span style=" font-size:12px; font-weight:bold;" >Dated 
					</span> <br /> 
                          <?php if(isset($data[0]->raw_approved)) echo date('d-F-Y',strtotime($data[0]->raw_approved)); ?>
                            </p>
                        </td>
				 ...
				 <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                    <tr style="border-bottom:1px solid #666;">
                        <td width="50%" rowspan="2" style="line-height:20px; padding-top: 0px; padding-bottom: 0px;border-right:1px solid #666;">
                            <p style="margin: 0px;">
                                <span style=" font-size:13px; font-weight:bold;" >Vendor </span>
									<br /><?php if(isset($data[0]->vendor_name)) echo $data[0]->vendor_name; ?>
									<br /><?php if(isset($vendor[0]->address)) echo $vendor[0]->address; ?><br />
									GSTIN:<?php if(isset($vendor[0]->gst_number)) echo $vendor[0]->gst_number; ?>
                    ...
                    <tr style="border-bottom:1px solid #666;">
                        <td width="50%" rowspan="2" style="line-height:20px; padding-top: 0px; padding-bottom: 0px;">
                            <p style="margin: 0px;">
                                <span style=" font-size:13px; font-weight:bold;" >Ship To 
								</span>
        ...
        <tr style="font-size:12px; font-weight:bold; ">
            <td width="50" align="center" valign="top"> Sr. No. </td>
            <td width="285" align="center" valign="top"> Item </td>
            <td width="110" align="center" valign="top"> HSN Code </td>
		...
		<td valign="top" align="center" style="border-left:1px solid #666; border-top: none; border-bottom:1px solid #666border:none;border-right:1px solid #666;"><p style="margin:0; "><?php echo $i+1; ?></p></td>
		 <td valign="top" align="center" style="border-left:1px solid #666; border-top: none; border-bottom:1px solid #666border:none;border-right:1px solid #666;"><p style="margin:0; ">
		 ...
		 <td valign="top" align="center" style="border-left:1px solid #666; border-top: none; border-bottom:1px solid #666border:none;border-right:1px solid #666;"><p style="margin:0; "><?php echo $raw_material_stock[$i]->hsn_code; ?></p></td>
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  <table style="width: 100%;border-spacing: 0; height: 17px;"><tr>
		...
		<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
		  <table style="width: 100%;border-spacing: 0; height: 17px;"><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="15%"></td>
		    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			  <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
			    <td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: center;" width="17%"></td>
        ...
        <tr>
			...
			<td colspan="3" valign="middle"><p style="margin:0;"><span style=" font-size:13px; font-weight:500;" >Remarks:</span> </p> </td>
