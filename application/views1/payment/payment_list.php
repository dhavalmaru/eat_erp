								...
								<table id="customers2" class="table datatable table-bordered"  >
									<thead>
										<tr>
											...
											<th width=" 100" style="text-align:center;">View Payment Slip</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/payment/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_deposit!=null && $data[$i]->date_of_deposit!='')?date('d/m/Y',strtotime($data[$i]->date_of_deposit)):''); ?></a></td>
											...
											<td style="text-align:center;vertical-align: middle;"><?php if ($data[$i]->id!=null) { ?><a href="<?php echo base_url().'index.php/payment/view_payment_slip/'.$data[$i]->id; ?>" target="_blank"> <span class="fa fa-file-pdf-o"></span></a><?php } ?></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
