    ...
    <body>								
        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/distributor_out'; ?>" >Distributor Out List </a>  &nbsp; &#10095; &nbsp; Distributor Out Details</div>
                <!-- PAGE CONTENT WRAPPER -->
                   <div class="page-content-wrap">
                      <div class="row main-wrapper">
					    <div class="main-container">           
                         <div class="box-shadow">	
                            <form id="form_distributor_out_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) {if(strrpos($data[0]->d_id, 'd_') !== false) echo base_url(). 'index.php/distributor_out/update/' . $data[0]->id; else echo base_url(). 'index.php/distributor_out/save';} else echo base_url().'index.php/distributor_out/save'; ?>">
                             <div class="box-shadow-inside">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <select class="form-control" name="delivery_status">
                                                    ...
                                                    <option value="In Transit" <?php if(isset($data)) {if ($data[0]->delivery_status=='In Transit') echo 'selected';}?>>In Transit</option>
                                ...
                                <div class="panel-footer">
									<a href="<?php echo base_url(); ?>index.php/distributor_out" class="btn btn-danger" type="reset" id="reset">Cancel</a>
        ...
        <script type="text/javascript">
            ...
            function get_total(){
                ...
                var cst_amount = total_amount*cst/100;
                var final_amount = total_amount + cst_amount;

                $("#total_amount").val(Math.round(total_amount*100)/100);
                $("#cst_amount").val(Math.round(cst_amount*100)/100);
