								...
								<table id="customers2" class="table datatable table-bordered" >
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/depot_transfer/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_transfer!=null && $data[$i]->date_of_transfer!='')?date('d/m/Y',strtotime($data[$i]->date_of_transfer)):''); ?></a></td>
