...
<table cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; width:512px; margin:auto; font-family:Arcon-Regular, OpenSans-Regular, Arcon, Verdana, Geneva, sans-serif; font-size:8px; font-weight:400; border:1px solid #666;"    >
  ...
  <tr>
    ...
    <td valign="top" style="border:0!important; font-size:8px; font-weight:500; text-align:right;"><?php if (isset($cst)) echo strval($cst) . '%'; ?></td>
    <td style=" font-size:8px; font-weight:500;"  >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right"><?php if (isset($cst_amount)) echo $cst_amount; ?></span> 
    </td>
  </tr>
  <tr>
    ...
    <td  style=" font-size:8px; font-weight:500;" >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right"><?php if (isset($total_amount_with_tax)) echo $total_amount_with_tax; ?></span> 
    </td>
  </tr>
  <tr>
