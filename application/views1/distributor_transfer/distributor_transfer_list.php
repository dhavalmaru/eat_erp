        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   ...
                   <div class="heading-h3-heading mobile-head">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp;   Distributor Transfer Entry List  </div>						 
					  ...
					  <div class="pull-right btn-margin">	
                       	...
                       	<div class="pull-right btn-margin" style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
									<a class="btn btn-success " href="<?php echo base_url() . 'index.php/distributor_transfer/add'; ?>">
								...
								<table id="customers2" class="table datatable table-bordered" >
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/distributor_transfer/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_transfer!=null && $data[$i]->date_of_transfer!='')?date('d/m/Y',strtotime($data[$i]->date_of_transfer)):''); ?></a></td>
