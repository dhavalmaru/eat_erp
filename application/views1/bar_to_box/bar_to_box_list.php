...
<style>
		  @media only screen and  (min-width:520px)  and (max-width:655px) { 
			.heading-h3-heading:first-child {     width: 43%!important;}
		   	.heading-h3-heading:last-child {     width: 57%!important;}				  
       ...
       <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   ...
                   <div class="heading-h3-heading">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp;  Bar To Box List  </div>						 
					  ...
					  <div class="pull-right btn-margin">	
                       	...
                       	<div class="pull-right btn-margin"  style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
									<a class="btn btn-success " href="<?php echo base_url() . 'index.php/bar_to_box/add'; ?>">
								...
								<table id="customers2" class="table datatable table-bordered"  >
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/bar_to_box/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_processing!=null && $data[$i]->date_of_processing!='')?date('d/m/Y',strtotime($data[$i]->date_of_processing)):''); ?></a></td>
