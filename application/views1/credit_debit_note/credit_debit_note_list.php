...
<html lang="en">
    <head>        
       ...
       <!-- CSS INCLUDE -->        
        ...
        <!-- EOF CSS INCLUDE -->    
		<style> 
		   @media only screen and  (min-width:645px)  and (max-width:740px) { 
								...
								<table id="customers2" class="table datatable table-bordered"  >
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/credit_debit_note/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_transaction!=null && $data[$i]->date_of_transaction!='')?date('d/m/Y',strtotime($data[$i]->date_of_transaction)):''); ?></a></td>
