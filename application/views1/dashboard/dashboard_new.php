                                    ...
                                    <div class="owl-carousel  " id="owl-example">  
                                        <div>    
                                            ...
                                            <div class="widget-data">
                                                ...
                                                <div class="widget-int"> &#8377; <span data-toggle="counter" data-to="<?php if(isset($total_sale[0]->total_amount)) echo format_money($total_sale[0]->total_amount,0);?>"><?php if(isset($total_sale[0]->total_amount)) echo format_money(($total_sale[0]->total_amount/100000),2) . ' Lacs';?></span></div>
                                            </div>   
                                        </div>
                                        <div>  
                                            <div class="widget-item-left">
