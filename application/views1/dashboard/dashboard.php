                        ...
                        <?php if(isset($product_details_for_distributor)){?>
                           <div class="full-width-devider" style="">
                            <div class="col-md-12">
                                ...
                                <!-- START WIDGET MESSAGES -->
                                <h2 style="float:left;    margin-bottom: 0;">Product Stock Details</h2>  <!-- <span style="fmargin-left:20px;margin-top:10px;margin-top: 5px; float: right; text-decoration: underline; font-size: 14px;"><a href="#">View all</a></span> -->      
                                <!-- END WIDGET MESSAGES -->
                                <div class="btn-group pull-right">
                                            <button class="btn btn-success dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Data</button>
                                            <ul class="dropdown-menu">
                        ...
                        <?php if(isset($box_details)){?>
                         <div class="full-width-devider" style="">
                            <div class="col-md-12">
                                ...
                                <!-- START WIDGET MESSAGES -->
                                <h2 style="float:left;    margin-bottom: 0;">Box Stock Details</h2>  <!-- <span style="fmargin-left:20px;margin-top:10px;margin-top: 5px; float: right; text-decoration: underline; font-size: 14px;"><a href="#">View all</a></span> -->      
                                <!-- END WIDGET MESSAGES -->
                                <div class="btn-group pull-right">
                                            <button class="btn btn-success dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Data</button>
                                            <ul class="dropdown-menu">
