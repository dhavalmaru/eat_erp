        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   ...
                   <div class="heading-h3-heading mobile-head">	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Raw Material In Entry List  </div>						 
					  ...
					  <div class="pull-right btn-margin">	
                    	...
                    	<div class="pull-right btn-margin" style="<?php if($access[0]->r_insert=='0') echo 'display: none;';?>">
									<a class="btn btn-success  " href="<?php echo base_url() . 'index.php/raw_material_in/add'; ?>">
										<span class="fa fa-plus"></span> Add Raw Material In Entry
									</a>
								</div>
								...
								<table id="customers2" class="table datatable table-bordered"  >
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/raw_material_in/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_receipt!=null && $data[$i]->date_of_receipt!='')?date('d/m/Y',strtotime($data[$i]->date_of_receipt)):''); ?></a></td>
