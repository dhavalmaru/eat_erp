							...
							<div class="panel-body">
								...
								<table id="customers2" class="table datatable table-bordered" style="border-top:none;">
									...
									<tbody>
										...
										<tr>
											<td><?php echo $i+1; ?></td>
											<td><a href="<?php echo base_url().'index.php/transfer/edit/'.$data[$i]->id; ?>"><?php echo (($data[$i]->date_of_transfer!=null && $data[$i]->date_of_transfer!='')?date('d/m/Y',strtotime($data[$i]->date_of_transfer)):''); ?></a></td>
