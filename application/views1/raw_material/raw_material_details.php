         ...
         <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
              ...
              <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                   <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/raw_material'; ?>" > Raw Material List </a>  &nbsp; &#10095; &nbsp; Raw Material Details</div>
                            ...
                            <form id="form_raw_material_details" role="form" class="form-horizontal" method="post" action="<?php if (isset($data)) echo base_url(). 'index.php/raw_material/update/' . $data[0]->id; else echo base_url().'index.php/raw_material/save'; ?>">
                              <div class="box-shadow-inside">
                                ...
                                <div class="panel-footer">
									<a href="<?php echo base_url(); ?>index.php/raw_material" class="btn btn-danger" type="reset" id="reset">Cancel</a>
